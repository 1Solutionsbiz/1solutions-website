...
const SVC_PILLARS = [
  ...
  },
  {
    ...
    subcats: [
      ...
      {
        id: 'ai-seo', label: 'AI SEO Services',
        services: [
          { name: 'AI Search Services',              desc: 'Get cited across all AI search engines',    href: '/ai-search-services/' },
          { name: 'Answer Engine Optimization',      desc: 'Optimise for featured snippets & PAA',      href: '/answer-engine-optimization-services/' },
          { name: 'AI SEO Services',                 desc: 'AI-powered search optimisation',            href: '/ai-seo-services/' },
          { name: 'ChatGPT SEO',                     desc: 'Get your brand cited in ChatGPT answers',   href: '/chatgpt-seo/' },
          { name: 'AI Integration Services',         desc: 'Connect AI models to your business',        href: '/ai-integration-services/' },
          { name: 'Perplexity AI SEO',               desc: 'Appear as a source in Perplexity AI',       href: '/perplexity-ai-seo/' },
          { name: 'Search Everywhere Optimization',  desc: 'Dominate Google, AI, social & voice',       href: '/search-everywhere-optimization/' },
          { name: 'Generative Engine Optimization',  desc: 'AI-generated answer optimisation',          href: '/generative-engine-optimization-services/' },
          { name: 'Google AI SEO',                   desc: 'Google AI Overviews & Gemini visibility',   href: '/google-ai-seo/' },
          { name: 'SearchGPT SEO',                   desc: 'OpenAI SearchGPT brand visibility',         href: '/searchgpt-seo/' },
          { name: 'Meta AI',                         desc: 'Meta AI on FB, Instagram & WhatsApp',       href: '/meta-ai-seo/' },
          { name: 'AI Utilization Review',           desc: 'Audit your AI tools & ROI roadmap',         href: '/ai-utilization-review/' },
          { name: 'Generative AI Services',          desc: 'Custom GenAI apps & content pipelines',     href: '/generative-ai-services/' },
          { name: 'AI Solutions',                    desc: 'End-to-end AI for business growth',         href: '/ai-solutions/' },
        ],
      },
    ],
  },
