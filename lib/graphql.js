...
/* ============================================================
   6. ALL CATEGORIES
   ============================================================ */
export async function getCategories({ first = 20, orderby = 'COUNT' } = {}) {
  const query = `
    query GetCategories($first: Int!) {
      categories(
        first: $first
        where: { hideEmpty: true, orderby: { field: ${orderby}, order: DESC } }
      ) {
        nodes {
          id
          databaseId
