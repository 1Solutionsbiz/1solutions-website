...
const SCHEMA = {
  ...
  '@graph': [
    ...
    },
    {
      '@type': 'FAQPage',
      mainEntity: [
        { '@type': 'Question', name: 'What is WordPress website maintenance?', acceptedAnswer: { '@type': 'Answer', text: 'WordPress website maintenance is the ongoing process of keeping your WordPress site secure, updated, backed up, and performing well — including security patches within 48 hours, staging-first updates, daily off-site backups, 24/7 uptime monitoring, malware scanning, and monthly developer hours for changes.' } },
        { '@type': 'Question', name: 'What is included in WordPress maintenance?', acceptedAnswer: { '@type': 'Answer', text: 'WordPress maintenance includes: core and plugin/theme updates tested on staging first; daily automated backups to AWS S3 or Backblaze B2; 24/7 uptime monitoring; weekly malware scanning; SSL management; broken link repair; Core Web Vitals monitoring; monthly reports; and developer hours. WooCommerce plans add payment gateway and checkout testing.' } },
        { '@type': 'Question', name: 'What happens if I don\'t maintain my WordPress website?', acceptedAnswer: { '@type': 'Answer', text: 'Outdated plugins and themes are the #1 WordPress attack vector. Unpatched vulnerabilities are exploited within hours. Plugin conflicts cause fatal errors and white screens. Performance degrades, backups may stop running, and SEO rankings drop as speed falls. Emergency hack recovery costs far more than a monthly retainer.' } },
        { '@type': 'Question', name: 'How much does WordPress maintenance cost?', acceptedAnswer: { '@type': 'Answer', text: 'Basic WordPress maintenance starts from $99–$149/month for small sites. Mid-tier plans with WooCommerce support, 4-hour SLA, and 8 developer hours run $249–$499/month. Enterprise plans with a dedicated engineer and 2-hour SLA are custom-priced. Contact us for a free WordPress health audit and tailored quote.' } },
        { '@type': 'Question', name: 'How often should WordPress be updated?', acceptedAnswer: { '@type': 'Answer', text: 'Security patches should be applied within 48 hours. Plugin updates monthly (sooner for security releases). Major WordPress versions assessed on staging over 2–4 weeks before production. Our maintenance service monitors all update streams on your behalf.' } },
        { '@type': 'Question', name: 'Can you fix a hacked WordPress website?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We scan files and database for malware, remove injected code and backdoors, restore from clean backup, patch the exploited vulnerability, and harden against recurrence. Clients on a maintenance retainer have malware removal included at no extra cost.' } },
        { '@type': 'Question', name: 'Do you support WooCommerce websites?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Our WooCommerce maintenance includes core and extension updates, payment gateway testing after every update, checkout flow regression testing, order email verification, and priority emergency response for payment failures on Professional and Enterprise plans.' } },
        { '@type': 'Question', name: 'Do you update plugins even if they might break the site?', acceptedAnswer: { '@type': 'Answer', text: 'Never directly to production. Every update goes to a staging clone first — we test for visual regressions and critical functionality. If an update causes a conflict on staging, we investigate, resolve or defer, and report in your monthly summary. Your live site only receives tested updates.' } },
        { '@type': 'Question', name: 'What WordPress security hardening do you apply?', acceptedAnswer: { '@type': 'Answer', text: 'Wordfence or Sucuri WAF; brute-force protection and login URL change; 2FA for admins; file permission hardening; XML-RPC disabled; version disclosure removed; DISALLOW_FILE_EDIT; security response headers (CSP, X-Frame-Options, HSTS); regular user role audits.' } },
        { '@type': 'Question', name: 'How do you handle WordPress emergencies?', acceptedAnswer: { '@type': 'Answer', text: 'All retainer clients have a dedicated emergency contact with plan SLAs: 2-hour for Enterprise, 4-hour for Professional, next-business-day for Essential. We handle white screens, fatal errors, hacks, WooCommerce payment failures, outages, and SSL lapses — then provide a written incident report.' } },
        { '@type': 'Question', name: 'Can you take over WordPress maintenance from another agency?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We start with a full WordPress audit covering core version, plugin vulnerabilities, security config, backup status, and performance baseline. You receive a written report before the retainer begins. We run month-to-month with no lock-in and provide a clean handover document if you ever leave.' } },
        { '@type': 'Question', name: 'What is a WordPress care plan?', acceptedAnswer: { '@type': 'Answer', text: 'A WordPress care plan is a monthly subscription covering all ongoing maintenance — updates, backups, security, monitoring, and developer support — on a predictable monthly cost with an included pool of developer hours for minor changes.' } },
        { '@type': 'Question', name: 'Do I need WordPress maintenance if my site is small?', acceptedAnswer: { '@type': 'Answer', text: 'Yes - all WordPress sites need maintenance regardless of size. A small brochure site has the same exposure to WordPress core vulnerabilities, plugin security flaws, and hosting environment changes as a large eCommerce site. In fact, smaller sites are often more vulnerable because they are less monitored. The essential maintenance tasks - security patches applied within 48 hours, daily backups, uptime monitoring, and malware scanning - apply equally to a 5-page business site and a 500-page WooCommerce store.' } },
        { '@type': 'Question', name: 'How long does it take to clean a hacked WordPress site?', acceptedAnswer: { '@type': 'Answer', text: 'Most WordPress malware removal engagements are completed within 4–12 hours of our receiving access. File-level and database injections typically resolve in under 4 hours. More complex compromises involving backdoors across multiple plugin files, or SEO spam poisoning thousands of database entries, may require 8–24 hours. We provide a written incident report after every malware removal engagement.' } },
        { '@type': 'Question', name: 'Do you support WooCommerce Subscriptions and Memberships?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. WooCommerce Subscriptions and Memberships add complexity to the update cycle - their renewal billing, member content access, and subscription management features must be tested after every WooCommerce core and extension update. Our process includes specific test cases for subscription renewal flows, membership access checks, and payment gateway token retention after updates.' } },
        { '@type': 'Question', name: 'What is a WordPress staging site?', acceptedAnswer: { '@type': 'Answer', text: 'A WordPress staging site is a private, password-protected clone of your live site - identical in content, theme, and plugins - used to test updates, new plugins, and design or code changes before deploying to production. All our maintenance clients have a staging environment configured as part of onboarding, and every update we apply goes to staging first.' } },
        { '@type': 'Question', name: 'How do you monitor WordPress uptime?', acceptedAnswer: { '@type': 'Answer', text: 'We use UptimeRobot, Better Uptime, or equivalent monitoring services configured with 1–5 minute check intervals. When your site returns a non-200 status code or exceeds a response time threshold, our team receives immediate alerts via email, Slack, and SMS. Enterprise plans also monitor from multiple geographic locations to detect regional CDN or DNS issues.' } },
        { '@type': 'Question', name: 'What is Core Web Vitals monitoring?', acceptedAnswer: { '@type': 'Answer', text: 'Core Web Vitals are Google\'s three page experience metrics: Largest Contentful Paint (LCP), Interaction to Next Paint (INP), and Cumulative Layout Shift (CLS). Google uses them as a ranking signal. Our maintenance plans include monthly Core Web Vitals tracking via Search Console and PageSpeed Insights, with regressions resolved within your monthly developer hours.' } },
        { '@type': 'Question', name: 'Can you help with WordPress performance optimization?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. All plans include caching configuration (WP Rocket, LiteSpeed Cache, or W3 Total Cache) and CDN setup via Cloudflare. Professional and Enterprise plans add Redis object caching, WebP image optimisation, GZIP/Brotli compression, database cleanup, and Core Web Vitals-focused performance work within your monthly developer hours.' } },
        { '@type': 'Question', name: 'Can you maintain WordPress on any hosting?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We maintain WordPress on all major hosting platforms - cPanel and Plesk shared hosting, managed WordPress hosting (WPEngine, Kinsta, Flywheel, Pressable), cloud-based hosting (Cloudways, AWS, DigitalOcean, Google Cloud), and dedicated servers. Our onboarding process captures your hosting environment details and configures our maintenance workflow accordingly.' } },
        { '@type': 'Question', name: 'What page builders do you support?', acceptedAnswer: { '@type': 'Answer', text: 'We maintain WordPress sites built with all major page builders: Elementor, Divi, WPBakery, Beaver Builder, Bricks Builder, Oxygen, and Gutenberg (Block Editor / Full Site Editing), as well as sites built with custom themes and custom Gutenberg blocks.' } },
        { '@type': 'Question', name: 'Do you maintain WordPress multisite networks?', acceptedAnswer: { '@type': 'Answer', text: 'Yes, on our Enterprise plan. Multisite networks require coordinated update management - WordPress core and network-activated plugins must be updated network-wide and tested across representative sub-sites, not just the main site. We maintain multisite networks for media groups, franchise organisations, agencies, and education institutions.' } },
        { '@type': 'Question', name: 'Do you provide a monthly WordPress maintenance report?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Every maintenance client receives a monthly report by the 5th business day of the following month covering all updates applied, security scan results, uptime statistics, Core Web Vitals trends, backup status, broken links repaired, developer hours used, and recommendations. Professional and Enterprise clients also receive a monthly account manager call.' } },
        { '@type': 'Question', name: 'What is the SLA for emergency WordPress support?', acceptedAnswer: { '@type': 'Answer', text: 'Enterprise: 2-hour initial response, 24/7 coverage. Professional: 4-hour initial response during business hours, with same-day escalation for WooCommerce checkout or payment emergencies. Essential: next-business-day response with a 4-hour priority escalation option available as a one-off add-on. All SLAs refer to initial contact and triage.' } },
        { '@type': 'Question', name: 'What is the difference between WordPress support and WordPress maintenance?', acceptedAnswer: { '@type': 'Answer', text: 'WordPress maintenance is proactive - regular, scheduled tasks (updates, backups, security scanning, monitoring) performed to prevent problems. WordPress support is reactive - help when something goes wrong. Our plans combine both: structured monthly maintenance that reduces support events, plus included emergency support when incidents do occur.' } },
        { '@type': 'Question', name: 'Do you manage WordPress hosting?', acceptedAnswer: { '@type': 'Answer', text: 'We do not sell or resell hosting, but we fully manage your WordPress hosting configuration as part of our maintenance service - PHP version compatibility, disk space and error log monitoring, server-level caching configuration, Cloudflare configuration, SSL certificate management, cron job monitoring, and database optimisation.' } },
        { '@type': 'Question', name: 'What if a plugin update breaks my site?', acceptedAnswer: { '@type': 'Answer', text: 'Because all our updates go to staging first, a plugin update that would break your site is caught before it ever reaches production. If a conflict appears on staging, we investigate the root cause and either resolve it, roll back the update pending a compatible version, or contact the plugin developer if required. Your live site always remains stable.' } },
        { '@type': 'Question', name: 'How do I get started with a WordPress maintenance plan?', acceptedAnswer: { '@type': 'Answer', text: 'Fill in our contact form with your WordPress site URL - we respond within one business day. We then carry out a free WordPress health audit and send you a written report with our recommended plan. Once you approve, we complete secure access onboarding and set up staging and monitoring tools - your retainer typically begins within 2–3 business days of sign-off.' } },
        { '@type': 'Question', name: 'What makes 1Solutions different from other WordPress maintenance services?', acceptedAnswer: { '@type': 'Answer', text: '15+ years of WordPress experience across 150+ maintained sites; a genuine staging-first workflow; WooCommerce checkout testing on every update, not just visual checks; security patches applied within 48 hours of CVE disclosure; transparent monthly reports naming every plugin updated; emergency response covered in every plan; and month-to-month rolling contracts with no lock-in.' } },
        { '@type': 'Question', name: 'Do you offer white-label WordPress maintenance for agencies?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We provide white-label WordPress maintenance for digital agencies - maintaining client WordPress and WooCommerce sites under your agency brand, with reports and client-facing documentation white-labelled. Agencies consolidate multiple client sites under a single retainer with a custom per-site rate.' } },
      ],
    },
    {
      '@type': 'Review',
...
const PROCESS_STEPS = [
  { num: '01', title: 'WordPress Audit & Onboarding', desc: 'We begin with a comprehensive WordPress audit: core version and update history, full plugin inventory with a WPScan vulnerability check, theme compatibility, security configuration, backup status, and a PageSpeed/Core Web Vitals baseline - delivered as a written report before the retainer begins. Then secure access handover (WordPress admin, hosting panel, FTP/SSH, domain registrar, Search Console) and a staging clone with monitoring tools configured, all without touching your live site.' },
  { num: '02', title: 'Immediate Priority Fixes', desc: 'Critical issues identified in the audit are resolved in week one: outdated WordPress core and plugins, unpatched security vulnerabilities, missing or broken backup configuration, absent SSL or expiring certificate, misconfigured user permissions, and any active malware detected during the initial security scan. These are resolved as priority work before the regular monthly maintenance cycle begins.' },
  { num: '03', title: 'Monthly WordPress Update Cycle', desc: 'Each month: all plugin and theme updates are applied to the staging clone, tested for compatibility (visual regression + functional tests on key pages and WooCommerce checkout if applicable), then deployed to production in a low-traffic window. WordPress minor version security patches applied within 48 hours of release. Major WordPress version updates assessed on staging over 2–4 weeks before production deployment.' },
  { num: '04', title: 'Monitoring, Incident Response & Reporting', desc: '24/7 uptime monitoring and regular security scans catch issues before they spread. When incidents do occur - hacks, white screens, payment failures - we respond within your plan SLA and follow up with a written report. By the 5th business day of each month you receive a full report covering every update applied, security scan results, uptime stats, Core Web Vitals trend, backup status, and developer hours used, plus a monthly account manager call on Professional and Enterprise plans.' },
];
  ...
  return (
    <>
      <Head>
        ...
        <meta key="og-image-alt" property="og:image:alt" content="1Solutions WordPress Support & Maintenance Services" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:image" content="https://www.1solutions.biz/images/og-wordpress-support-and-maintenance-services.jpg" />
        <meta name="twitter:image:alt" content="1Solutions WordPress Support & Maintenance Services" />
        ...
        <style>{`
          ...
          .wm-process-section{background:#fff;border-top:1px solid rgba(15,52,96,.06);padding:90px 40px;position:relative;z-index:1}
          .wm-process-inner{max-width:1280px;margin:0 auto;display:grid;grid-template-columns:1fr 1fr;gap:80px;align-items:center}
          .wm-process-steps{display:flex;flex-direction:column;gap:0}
          .wm-pstep{display:grid;grid-template-columns:56px 1fr;gap:20px;align-items:flex-start;padding:28px 0;border-bottom:1px solid rgba(15,52,96,.06);opacity:0;transform:translateX(-20px);transition:opacity .45s ease,transform .45s ease}
          .wm-pstep:last-child{border-bottom:none}
          .wm-pstep.wm-pv{opacity:1;transform:translateX(0)}
          .wm-pstep-num{font-size:2.8rem;font-weight:900;color:rgba(15,52,96,.12);line-height:1;letter-spacing:-2px}
          .wm-pstep-body h3{font-size:1.05rem;font-weight:800;color:#0F1F40;margin:0 0 6px}
          .wm-pstep-body p{font-size:.88rem;color:#4A6080;line-height:1.7;margin:0}
          .wm-process-image-col{position:sticky;top:100px}
          .wm-process-image-col img{width:100%;border-radius:20px;box-shadow:0 24px 72px rgba(15,52,96,.12)}
      ...
      <div className="wm-page">
        ...
        <ServiceHero
          ...
          title={<>WordPress Support & Maintenance Services - <AuroraText>Secure, Updated & Fully Supported</AuroraText></>}
        ...
        <section className="wm-process-section" id="process" aria-labelledby="wm-proc-heading">
          <div className="wm-process-inner">
            <div className="wm-process-steps">
              ...
              {PROCESS_STEPS.map((step, i) => (
                <div key={step.num} className={`wm-pstep${visibleSections.has('proc') ? ' wm-pv' : ''}`} style={{ transitionDelay: `${i * 120}ms` }}>
                  <span className="wm-pstep-num">{step.num}</span>
                  <div className="wm-pstep-body">
                    <h3>{step.title}</h3>
                    <p>{step.desc}</p>
                  </div>
                </div>
            ...
            <div className="wm-process-image-col">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/images/wordpress-support-and-maintenance-services.jpg" alt="1Solutions WordPress maintenance - security monitoring, updates, backups, and performance optimisation" width={576} height={720} />
            </div>
          </div>
        </section>
