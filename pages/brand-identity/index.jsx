  ...
  return (
    <>
      <Head>
        ...
        <meta key="og-image" property="og:image" content="https://www.1solutions.biz/images/og-brand-identity.jpg" />
        <meta key="og-image-w" property="og:image:width" content="1200" />
        <meta key="og-image-h" property="og:image:height" content="630" />
        <meta key="og-image-type" property="og:image:type" content="image/jpeg" />
        <meta property="og:image:alt" content="1Solutions Brand Identity Design" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:image" content="https://www.1solutions.biz/images/og-brand-identity.jpg" />
        <meta name="twitter:image:alt" content="1Solutions Brand Identity Design" />
          ...
          <div className="bi-contact-container">
            ...
            <div>
              <div className="bi-form-box">
                ...
                <form className="bi-contact-form" onSubmit={_sfSubmit}>
                  <div className="bi-form-row">
                    <div className="bi-form-group"><label>Full Name*</label><input name="sf-name" type="text" placeholder="Full Name*" required /></div>
                    <div className="bi-form-group"><label>Business Email*</label><input type="email" name="sf-email" placeholder="Business Email*" required /></div>
                  </div>
                  <div className="bi-form-row">
                    ...
                    <div className="bi-form-group"><label>Company*</label><input name="sf-company" type="text" placeholder="Company / Organisation*" required /></div>
                  </div>
                  <div className="bi-form-group full">
                    <label>Tell us about your project*</label>
                    <textarea name="sf-message" placeholder="Describe your brand, your target audience, and what you need..." rows={5} required />
                  </div>
