    ...
    try {
      ...
      const res = await fetch('/api/contact', {
        ...
        body: JSON.stringify({
          ...
          source: 'Manufacturing Software Development Services', consent: true, recaptchaToken: token,
        }),
      });
  ...
  return (
    <>
      ...
      <div className="mfg-page">
        ...
        <div className="mfg-fb"><h3>Tell Us About Your Manufacturing Project</h3><form className="mfg-form" onSubmit={_sfSubmit}><div className="mfg-fr"><div className="mfg-fg"><label>Full Name *</label><input name="sf-name" type="text" placeholder="Your name" required /></div><div className="mfg-fg"><label>Work Email *</label><input type="email" name="sf-email" placeholder="you@company.com" required /></div></div><div className="mfg-fr"><div className="mfg-fg"><label>Company / Plant</label><input name="sf-name" type="text" placeholder="Company name" /></div><div className="mfg-fg"><label>Phone / WhatsApp *</label><input type="tel" name="sf-phone" placeholder="+1 555 000 0000" required /></div></div><div className="mfg-fg full"><label>Type of Manufacturing System *</label><select required><option value="">Select...</option><option>Manufacturing Execution System (MES)</option><option>ERP Integration (SAP / Oracle / Dynamics)</option><option>IIoT Factory Monitoring</option><option>Predictive Maintenance</option><option>Quality Management System (QMS)</option><option>Production Planning & Scheduling</option><option>Supply Chain Visibility</option><option>Traceability / Batch Tracking</option><option>Digital Work Instructions</option><option>OEE Analytics Dashboard</option><option>Other</option></select></div><div className="mfg-fg full"><label>Project Description *</label><textarea name="sf-message" rows={4} placeholder="Describe your manufacturing software project - industry (automotive, food, pharma, etc.), current systems (ERP, SCADA, PLC types), key challenges, and timeline..." required /></div><div className="mfg-co"><input type="checkbox" required /><label>I agree to the <Link href="/privacy-policy/">Privacy Policy</Link>. Details are treated confidentially.</label></div><button type="submit" className="mfg-sub">Get a Manufacturing Software Proposal →</button>
