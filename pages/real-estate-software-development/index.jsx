    ...
    try {
      ...
      const res = await fetch('/api/contact', {
        ...
        body: JSON.stringify({
          ...
          source: 'Real Estate Software Development', consent: true, recaptchaToken: token,
        }),
      });
    ...
    <>
      <Head>
        ...
        <style>{`
          ...
          .re-cth{font-size:38px;font-weight:900;line-height:1.18;margin:0 0 12px;background:linear-gradient(135deg,#4f46e5,#7c3aed,#a855f7,#ec4899,#3b82f6,#06b6d4,#4f46e5);background-size:300% 300%;animation:aurora-text 6s ease infinite;-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}
          ...
          .re-ri h2{font-size:30px;font-weight:900;background:linear-gradient(135deg,#4f46e5,#7c3aed,#a855f7,#ec4899,#3b82f6,#06b6d4,#4f46e5);background-size:300% 300%;animation:aurora-text 6s ease infinite;-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;margin:10px 0 10px}
      ...
      <div className="re-page">
        ...
        <div className="re-fb"><h3>Tell Us About Your Real Estate Project</h3><form className="re-form" onSubmit={_sfSubmit}><div className="re-fr"><div className="re-fg"><label>Full Name *</label><input name="sf-name" type="text" placeholder="Your name" required /></div><div className="re-fg"><label>Work Email *</label><input type="email" name="sf-email" placeholder="you@company.com" required /></div></div><div className="re-fr"><div className="re-fg"><label>Company</label><input name="sf-company" type="text" placeholder="Your company" /></div><div className="re-fg"><label>Phone / WhatsApp</label><input type="tel" name="sf-phone" placeholder="+1 555 000 0000" /></div></div><div className="re-fg full"><label>Type of Real Estate Platform *</label><select required><option value="">Select...</option><option>Property Listing Portal</option><option>MLS / IDX Integration</option><option>Real Estate CRM</option><option>Property Management System (PMS)</option><option>Commercial Real Estate Platform</option><option>PropTech Mobile App</option><option>Virtual Tour Platform</option><option>Mortgage Calculator / Affordability Tool</option><option>Other</option></select></div><div className="re-fg full"><label>Project Description *</label><textarea name="sf-message" rows={4} placeholder="Describe your real estate software project - type of platform, current system (if any), key features needed, target markets, and timeline..." required /></div><div className="re-co"><input type="checkbox" required /><label>I agree to the <Link href="/privacy-policy">Privacy Policy</Link>. Details are treated confidentially.</label></div><button type="submit" className="re-sub">Get a PropTech Proposal →</button>
