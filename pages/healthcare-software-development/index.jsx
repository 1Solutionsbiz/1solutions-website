  ...
  return (
    <>
      <Head>
        ...
        <meta key="og-image" property="og:image" content="https://www.1solutions.biz/images/og-healthcare-software-development.jpg" />
        <meta key="og-image-w" property="og:image:width" content="1200" />
        <meta key="og-image-h" property="og:image:height" content="630" />
        <meta key="og-image-type" property="og:image:type" content="image/jpeg" />
        <meta property="og:image:alt" content="1Solutions Healthcare Software Development" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:image" content="https://www.1solutions.biz/images/og-healthcare-software-development.jpg" />
        <meta name="twitter:image:alt" content="1Solutions Healthcare Software Development" />
        ...
        <style>{`
          ...
          .hc-related h2 { font-size:34px;font-weight:900;background:linear-gradient(135deg,#4f46e5,#7c3aed,#a855f7,#ec4899,#3b82f6,#06b6d4,#4f46e5);background-size:300% 300%;animation:aurora-text 6s ease infinite;-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;margin:10px 0 12px; }
          ...
          @media(max-width:1024px){
            .hc-s-title,.hc-faq h2 { font-size:36px; }
      ...
      <div className="hc-page">
        ...
        {/* ── HERO ── */}
        <ServiceHero
          eyebrow="Healthcare Software Development · HIPAA Compliant · HL7 FHIR R4"
          title={<>Custom Healthcare Software Development - <AuroraText>HIPAA-Compliant, HL7 FHIR-Ready</AuroraText></>}
          subtext="We design and develop EHR/EMR systems, telemedicine platforms, patient portals, medical billing software, and AI-powered clinical tools for hospitals, clinics, and healthtech startups across the US, Canada, and Australia."
          primaryCta={{ label: 'Start Your Healthcare Project', href: '#contact' }}
          secondaryCta={{ label: 'View Engagement Models', href: '#engagement' }}
          stats={[
            { label: 'Healthcare Clients', value: '50', suffix: '+' },
