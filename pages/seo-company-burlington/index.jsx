  ...
  return (
    <>
      <Head>
        ...
        <meta key="og-image" property="og:image" content="https://www.1solutions.biz/images/og-seo-company-burlington.jpg" />
        <meta key="og-image-w" property="og:image:width" content="1200" />
        <meta key="og-image-h" property="og:image:height" content="630" />
        <meta key="og-image-type" property="og:image:type" content="image/jpeg" />
        <meta property="og:image:alt" content="1Solutions SEO Company in Burlington Ontario" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:image" content="https://www.1solutions.biz/images/og-seo-company-burlington.jpg" />
        <meta name="twitter:image:alt" content="1Solutions SEO Company in Burlington Ontario" />
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(LD) }} />
        <style>{`
          *{box-sizing:border-box;}
          body{margin:0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;}
          .burl-bc a:hover{color:#1a3d0a;}.burl-bc-cur{color:#1a3d0a;font-weight:500;}
          ...
          @media(max-width:600px){.burl-sec,.burl-results,.burl-cta,.burl-contact-sec{padding-left:20px;padding-right:20px;}.burl-grid4,.burl-grid3,.burl-grid2,.burl-res-grid,.burl-ind-grid{grid-template-columns:1fr;}.burl-bc{padding:12px 20px;}.burl-field-row{grid-template-columns:1fr;}.burl-form-wrap{padding:24px 20px;}}
      ...
      <ServiceHero
        eyebrow="SEO Company in Burlington, Ontario · Halton Region Specialists"
        title={<>Top-Ranked <AuroraText>SEO Company in Burlington</AuroraText> That Delivers Page 1 Rankings</>}
        subtext="1Solutions is a results-driven SEO company in Burlington Ontario with 15+ years of experience helping Halton Region businesses rank on Page 1 of Google. From technical SEO and local search to link building and content strategy - we build organic visibility that generates qualified leads in Burlington and the GTA West corridor."
            ...
            <div className="burl-form-wrap">
              {sent ? (
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="burl-field-row">
                    <div className="burl-field"><label>Phone Number *</label><input type="tel" placeholder="+1 905 000 0000" value={form.phone} onChange={e => setForm({...form,phone:e.target.value})} required /></div>
