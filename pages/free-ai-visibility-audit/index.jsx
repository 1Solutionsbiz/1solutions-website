        ...
        <section className="pl-sec pl-white">
          <div className="pl-in">
            <div className="pl-reveal" style={{textAlign:'center'}}>
              ...
              <p className="pl-lead" style={{margin:'0 auto 40px'}}>We systematically test your brand visibility across every major AI platform and search signal - not just one or two. If a potential customer is using it to find businesses like yours, we check it.</p>
            </div>
