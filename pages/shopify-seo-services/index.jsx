  ...
  return (
    <>
      <Head>
        ...
        <meta key="og-image" property="og:image" content="https://www.1solutions.biz/images/og-shopify-seo-services.jpg" />
        <meta key="og-image-w" property="og:image:width" content="1200" />
        <meta key="og-image-h" property="og:image:height" content="630" />
        <meta key="og-image-type" property="og:image:type" content="image/jpeg" />
        <meta property="og:image:alt" content="1Solutions Shopify SEO Services — Shopify store SEO specialists" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:image" content="https://www.1solutions.biz/images/og-shopify-seo-services.jpg" />
        <meta name="twitter:image:alt" content="1Solutions Shopify SEO Services — Shopify store SEO specialists" />
        ...
        <style>{`
          ...
          .shseo-bc a:hover{color:#008060}.shseo-bc span{color:#d1d5db}
          ...
          @media(max-width:768px){.shseo-svc,.shseo-plat,.shseo-proc,.shseo-why,.shseo-faq,.shseo-cta{padding:60px 24px}.shseo-grid{grid-template-columns:1fr}.shseo-why-grid{grid-template-columns:1fr}.shseo-step{grid-template-columns:56px 1fr}}
      ...
      <div className="shseo-page">
        <ServiceHero
          ...
          stats={[
            ...
            { label: 'Avg Organic Traffic Lift', value: '280', prefix: '+', suffix: '%' },
