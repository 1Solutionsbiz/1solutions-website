    ...
    try {
      ...
      const res = await fetch('/api/contact', {
        ...
        body: JSON.stringify({
          ...
          source: 'Elearning Software Development Services', consent: true, recaptchaToken: token,
        }),
      });
  ...
  return (
    <>
      <Head>
        ...
        <meta key="og-image" property="og:image" content="https://www.1solutions.biz/images/og-elearning-software-development-services.jpg" />
        <meta key="og-image-w" property="og:image:width" content="1200" />
        <meta key="og-image-h" property="og:image:height" content="630" />
        <meta key="og-image-type" property="og:image:type" content="image/jpeg" />
        <meta property="og:image:alt" content="1Solutions eLearning Software Development" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:image" content="https://www.1solutions.biz/images/og-elearning-software-development-services.jpg" />
        <meta name="twitter:image:alt" content="1Solutions eLearning Software Development" />
        ...
        <style>{`
          ...
          .el-related h2 { font-size:34px;font-weight:900;background:linear-gradient(135deg,#4f46e5,#7c3aed,#a855f7,#ec4899,#3b82f6,#06b6d4,#4f46e5);background-size:300% 300%;animation:aurora-text 6s ease infinite;-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;margin:10px 0 12px; }
          ...
          @media(max-width:1024px){
            .el-s-title,.el-faq h2 { font-size:36px; }
      ...
      <div className="el-page">
        ...
        {/* ── HERO ── */}
        <ServiceHero
          eyebrow="eLearning Software Development Company · SCORM & xAPI Compliant · LTI 1.3"
          title={<>eLearning Software Development - <AuroraText>Engaging, Scalable &amp; Standards-Compliant</AuroraText></>}
          subtext="We build custom LMS platforms, SCORM/xAPI-compliant course engines, virtual classrooms, adaptive learning systems, and corporate training portals for EdTech startups, universities, enterprises, and online training providers across the US, UK, Australia, and beyond."
          primaryCta={{ label: 'Start Your eLearning Project', href: '#contact' }}
          secondaryCta={{ label: 'View Engagement Models', href: '#engagement' }}
          stats={[
            { label: 'EdTech Clients', value: '80', suffix: '+' },
        ...
        <section id="contact" className="el-contact" aria-labelledby="el-contact-heading">
          <div className="el-contact-grid">
            ...
            <div className="el-form-box">
              ...
              <form className="el-form" onSubmit={_sfSubmit}>
                <div className="el-frow">
                  <div className="el-fg">
                    <label htmlFor="el-name">Full Name *</label>
                    <input name="sf-name" id="el-name" type="text" placeholder="Your name" required />
                  </div>
                  <div className="el-fg">
                    <label htmlFor="el-email">Work Email *</label>
                    <input id="el-email" type="email" name="sf-email" placeholder="you@company.com" required />
                  </div>
                </div>
                <div className="el-frow">
                  <div className="el-fg">
                  ...
                  <div className="el-fg">
                    ...
                    <input id="el-phone" type="tel" name="sf-phone" placeholder="+1 555 000 0000" required />
                  </div>
                </div>
