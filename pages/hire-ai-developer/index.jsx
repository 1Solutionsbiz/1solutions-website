    ...
    try {
      ...
      const res = await fetch('/api/contact', {
        ...
        body: JSON.stringify({
          ...
          source: 'Hire Ai Developer', consent: true, recaptchaToken: token,
        }),
      });
  ...
  return (
    <>
      <Head>
        ...
        <meta key="og-image" property="og:image" content="https://www.1solutions.biz/images/og-hire-ai-developer.jpg" />
        <meta key="og-image-w" property="og:image:width" content="1200" />
        <meta key="og-image-h" property="og:image:height" content="630" />
        <meta key="og-image-type" property="og:image:type" content="image/jpeg" />
        <meta property="og:image:alt" content="1Solutions Hire AI Developer" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:image" content="https://www.1solutions.biz/images/og-hire-ai-developer.jpg" />
        <meta name="twitter:image:alt" content="1Solutions Hire AI Developer" />
        ...
        <style>{`
          ...
          .hia-rel h2{font-size:34px;font-weight:900;background:linear-gradient(135deg,#4f46e5,#7c3aed,#a855f7,#ec4899,#3b82f6,#06b6d4,#4f46e5);background-size:300% 300%;animation:aurora-text 6s ease infinite;-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;margin:10px 0 12px}
      ...
      <div className="hia-page">
        ...
        <div className="hia-form-box"><h3>Tell Us Your AI Requirements</h3><form className="hia-form" onSubmit={_sfSubmit}>
          <div className="hia-frow"><div className="hia-fg"><label htmlFor="hia-name">Full Name *</label><input name="sf-name" id="hia-name" type="text" placeholder="Your name" required /></div><div className="hia-fg"><label htmlFor="hia-email">Work Email *</label><input id="hia-email" type="email" name="sf-email" placeholder="you@company.com" required /></div></div>
          <div className="hia-frow"><div className="hia-fg"><label htmlFor="hia-co">Company Name</label><input name="sf-company" id="hia-co" type="text" placeholder="Your company" /></div><div className="hia-fg"><label htmlFor="hia-ph">Phone / WhatsApp *</label><input id="hia-ph" type="tel" name="sf-phone" placeholder="+1 555 000 0000" required /></div></div>
