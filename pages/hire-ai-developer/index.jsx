    ...
    <>
      ...
      <div className="hia-page">
        ...
        <div className="hia-form-box"><h3>Tell Us Your AI Requirements</h3><form className="hia-form" onSubmit={e => e.preventDefault()}>
          ...
          <div className="hia-frow"><div className="hia-fg"><label htmlFor="hia-co">Company Name</label><input id="hia-co" type="text" placeholder="Your company" /></div><div className="hia-fg"><label htmlFor="hia-ph">Phone / WhatsApp *</label><input id="hia-ph" type="tel" placeholder="+1 555 000 0000" required /></div></div>
