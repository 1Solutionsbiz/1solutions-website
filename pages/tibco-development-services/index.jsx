    ...
    <>
      <Head>
        ...
        <style>{`
          ...
          .tb-related h2{font-size:34px;font-weight:900;background:linear-gradient(135deg,#4f46e5,#7c3aed,#a855f7,#ec4899,#3b82f6,#06b6d4,#4f46e5);background-size:300% 300%;animation:aurora-text 6s ease infinite;-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;margin:10px 0 12px}
          ...
          <div className="tb-inner">
            ...
            <div className="tb-tgrid" ref={testiGridRef}>
              {TESTIMONIALS.map((t, i) => (
                <div key={i} className={`tb-tcard${t.feat ? ' feat' : ''}${visibleTestiCards.includes(i) ? ' tb-tv' : ''}`} style={{ transitionDelay: `${i * 100}ms` }}>
                  <div className="tb-stars" aria-label="5 out of 5 stars">★★★★★</div>
                  <p className="tb-ttext">{t.text}</p>
                  <div className="tb-tauthor">
                    <div className="tb-tavatar" style={{ background: t.bg }}>{t.init}</div>
                    <div><div className="tb-tname">{t.name}</div><div className="tb-trole">{t.role}</div></div>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="tb-contact-grid">
            ...
            <div className="tb-form-box">
              ...
              <form className="tb-form" onSubmit={_sfSubmit}>
                ...
                <div className="tb-frow">
                  <div className="tb-fg"><label htmlFor="tb-company">Company / Organisation</label><input name="sf-company" id="tb-company" type="text" placeholder="Your company name" /></div>
