...
const STATIC_PAGES = [
  ...
  { url: '/case-studies/comtradesol',            priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/rngfoundation',          priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/aiplusstore',            priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/keiyura',                priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/asiandispatch',          priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/vns',                    priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/shopsamsin',             priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/foreverring',            priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/parfumfrance',           priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/305aero',                priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/yaahdy',                 priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/copalcollective',        priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/explorehonor',           priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/recreator',              priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/expetize',               priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/novanttum',              priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/febestbanksawards',      priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/intellismart',           priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/runaya',                 priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/freyrenergy',            priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/xcelaccounting',         priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/phdcci',                 priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/aiinnovationsummit',     priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/zincfootball',           priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/youngmonk',              priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/greycellpr',             priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/empor',                  priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/truckinsurancefl',       priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/astropraveen',           priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/defencenewsupdates',     priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/defenceaviationpost',    priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/playaorthodontics',      priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/skinlasercentre',        priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/adiuvo',                 priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/smefutures',             priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/mountsystems',           priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/charlespuma',            priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/creativeinterior',       priority: '0.7', changefreq: 'monthly' },
  { url: '/case-studies/throneportapotties',     priority: '0.7', changefreq: 'monthly' },
  { url: '/open-positions',                      priority: '0.6', changefreq: 'weekly' },
  { url: '/apply-online',                        priority: '0.5', changefreq: 'monthly' },
  { url: '/apply-online/full-stack-developer-opening',        priority: '0.4', changefreq: 'monthly' },
  { url: '/apply-online/social-media-manager-opening',        priority: '0.4', changefreq: 'monthly' },
  { url: '/apply-online/business-development-manager-opening', priority: '0.4', changefreq: 'monthly' },
  { url: '/apply-online/digital-marketing-trainee-opening',   priority: '0.4', changefreq: 'monthly' },
  ...
  { url: '/ai-automation-services',              priority: '0.9', changefreq: 'monthly' },
  ...
  { url: '/ecommerce-seo-packages',              priority: '0.9', changefreq: 'monthly' },
  ...
  { url: '/white-label-seo-services',            priority: '0.9', changefreq: 'monthly' },
  { url: '/white-label-ppc-services',            priority: '0.9', changefreq: 'monthly' },
  ...
  { url: '/search-everywhere-optimization',      priority: '0.7', changefreq: 'monthly' },
  { url: '/chatgpt-seo',                         priority: '0.7', changefreq: 'monthly' },
  { url: '/perplexity-ai-seo',                   priority: '0.7', changefreq: 'monthly' },
  { url: '/searchgpt-seo',                       priority: '0.7', changefreq: 'monthly' },
  { url: '/google-ai-seo',                       priority: '0.7', changefreq: 'monthly' },
  { url: '/meta-ai-seo',                         priority: '0.7', changefreq: 'monthly' },
  { url: '/ai-integration-services',             priority: '0.7', changefreq: 'monthly' },
  { url: '/ai-solutions',                        priority: '0.7', changefreq: 'monthly' },
  { url: '/generative-ai-services',              priority: '0.7', changefreq: 'monthly' },
  { url: '/ai-utilization-review',               priority: '0.6', changefreq: 'monthly' },
  ...
  { url: '/conversion-rate-optimization-services', priority: '0.9', changefreq: 'monthly' },
  { url: '/performance-marketing-agency',          priority: '0.9', changefreq: 'monthly' },
