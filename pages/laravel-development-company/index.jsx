  ...
  return (
    <>
      <Head>
        ...
        <meta key="og-image" property="og:image" content="https://www.1solutions.biz/images/og-laravel-development-company.jpg" />
        <meta key="og-image-w" property="og:image:width" content="1200" />
        <meta key="og-image-h" property="og:image:height" content="630" />
        <meta key="og-image-type" property="og:image:type" content="image/jpeg" />
        <meta property="og:image:alt" content="1Solutions Laravel Development Company" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:image" content="https://www.1solutions.biz/images/og-laravel-development-company.jpg" />
        <meta name="twitter:image:alt" content="1Solutions Laravel Development Company" />
        <style>{`
          .lv-page {
      ...
      <div className="lv-page">
        {/* ── HERO ── */}
        <ServiceHero
          eyebrow="Expert Laravel Development Company"
          title={<>Laravel Development Services - Build <AuroraText>Powerful PHP Applications</AuroraText>, Faster</>}
          subtext="From SaaS platforms and REST APIs to multi-tenant applications and e-commerce backends - 1Solutions delivers production-grade Laravel solutions for businesses across the US, Canada, and Australia. Clean code, full tests, on-time delivery."
          primaryCta={{ label: 'Get a Free Consultation Now', href: '#contact' }}
          stats={[
            { label: 'Laravel Projects', value: '200', suffix: '+' },
            { label: 'PHP/Laravel Experts', value: '25', suffix: '+' },
