...
const PROJECTS = [
  ...
  },
  {
    ...
    tech: ['Custom Build', 'UI/UX Design'],
    desc: 'Bulk email verification platform with 10+ validation layers — detecting disposable addresses, catch-all domains, and blacklisted emails. Used by teams at Salesforce, HubSpot, Mailchimp, and Apollo.',
  ...
  {
    id: 'astropraveen',
    title: 'AstroPraveen — Astrology Services',
    category: 'Web Development',
    industry: 'Wellness & Spirituality',
    tech: ['WordPress', 'Custom Theme', 'UI/UX Design'],
    desc: 'Personal brand website for Dr. Praveen Chauhan — an Asia Book of Records holder offering horoscope reading, corporate astrology, palmistry, and film astrology to celebrities, executives, and global clients.',
  ...
  },
  {
    ...
    title: 'Defence News Updates — News Portal',
    category: 'Web Development',
    industry: 'Defence & Media',
    tech: ['WordPress', 'Custom Theme', 'UI/UX Design'],
    desc: 'Indian defence and security news portal with dedicated coverage of Army, Navy, Air Force, DRDO programmes, indigenous weapons development, and global military developments.',
  ...
  {
    id: 'empor',
    title: 'Empor Marcom — B2B Marketing',
    category: 'Web Development',
    industry: 'B2B Marketing',
    tech: ['WordPress', 'Custom Theme', 'UI/UX Design'],
    desc: 'Agency website for Empor Marcom, a pan-India B2B marketing firm — delivering lead generation, telemarketing, virtual events, and content syndication for enterprise clients including AWS, Microsoft, and Salesforce.',
  ...
  {
    id: 'uvcapital',
    title: 'UV Capital — Investment Banking',
    category: 'Web Development',
    industry: 'Investment Banking',
    tech: ['WordPress', 'Custom Theme', 'UI/UX Design'],
    desc: 'Corporate website for Unified Vision Capital — a global investment banking firm with $3B+ in transaction value, 100+ deals, and 14+ years of expertise in private equity, debt fundraising, M&A, and corporate advisory.',
  ...
  {
    id: 'novanttum',
    title: 'Novanttum — Alternative Investments',
    category: 'Web Development',
    industry: 'Alternative Investments',
    tech: ['WordPress', 'Custom Theme', 'UI/UX Design'],
    desc: 'Investment platform website for Novanttum Alternatives — a SEBI-registered AIF offering private credit, equity, and structured finance to high-potential businesses, led by professionals with 15–39 years of industry experience.',
    image: '/images/portfolio/novanttum.png',
    featured: false,
  },
  {
    id: 'truckinsurancefl',
    title: 'TruckInsuranceFL — Commercial Insurance',
    category: 'Web Development',
    industry: 'Insurance',
    tech: ['WordPress', 'Custom Theme', 'UI/UX Design'],
    desc: "Florida's trusted commercial truck insurance specialists — serving owner-operators and fleets with same-day coverage, instant quotes, and FMCSA-compliant policies backed by 34+ years of industry experience.",
    image: '/images/portfolio/truckinsurancefl.png',
    featured: false,
  },
  {
    id: 'aiinnovationsummit',
    title: 'AI Innovation Summit 2026',
    category: 'Web Development',
    industry: 'Technology & Events',
    tech: ['Next.js', 'UI/UX Design'],
    desc: 'Event website for the AI Innovation Summit 2026 — a forward-looking technology conference bringing together industry leaders, researchers, and innovators to explore the cutting edge of artificial intelligence.',
    image: '/images/portfolio/aiinnovationsummit.png',
    featured: false,
  },
  {
    id: 'febestbanksawards',
    title: 'FE Best Banks Awards',
    category: 'Web Development',
    industry: 'Banking & Finance',
    tech: ['WordPress', 'Custom Theme', 'UI/UX Design'],
    desc: "Award portal for the Financial Express Best Banks Awards — India's highest honour in banking excellence, with EY as knowledge partner, recognising top performers across public, private, foreign banks, NBFCs, and fintechs.",
    image: '/images/portfolio/febestbanksawards.png',
    featured: false,
  },
  {
    id: 'intellismart',
    title: 'IntelliSmart Infra — Smart Infrastructure',
    category: 'Web Development',
    industry: 'Infrastructure',
    tech: ['WordPress', 'Custom Theme', 'UI/UX Design'],
    desc: 'Corporate website for IntelliSmart Infrastructure — a sustainability-focused company delivering smart infrastructure solutions across India.',
    image: '/images/portfolio/intellismart.png',
    featured: false,
  },
  {
    id: 'runaya',
    title: 'Runaya — Sustainable Manufacturing',
    category: 'Web Development',
    industry: 'Manufacturing',
    tech: ['WordPress', 'Custom Theme', 'UI/UX Design'],
    desc: "Website for Runaya, India's first zero-waste, zero-discharge aluminium processing facility — recovering 16,000 MT of green aluminium annually and generating INR 400 Cr revenue, with a 50% women workforce.",
    image: '/images/portfolio/runaya.png',
    featured: false,
  },
  {
    id: 'freyrenergy',
    title: 'Freyr Energy — Rooftop Solar',
    category: 'Web Development',
  ...
  {
    id: 'xcelaccounting',
    title: 'Xcel Accounting — Financial Services',
    category: 'Web Development',
    industry: 'Accounting & Finance',
    tech: ['WordPress', 'Custom Theme', 'UI/UX Design'],
    desc: 'Professional services website for Xcel Accounting, Dubai — a Xero Gold Partner offering fractional CFO, outsourced accounting, internal audits, business valuation, and VAT services to businesses across the UAE.',
    image: '/images/portfolio/xcelaccounting.png',
    featured: false,
  },
  {
    id: 'youngmonk',
