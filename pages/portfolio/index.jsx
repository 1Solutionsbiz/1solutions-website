...
const PROJECTS = [
  ...
  },
  {
    ...
    category: 'eCommerce',
    industry: 'Aviation',
    tech: ['Shopify', 'Liquid', 'B2B'],
    desc: 'Specialised Shopify store for aviation parts and supplies — built for pilot and aircraft maintenance professionals across the US.',
