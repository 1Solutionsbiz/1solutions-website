  ...
  return (
    <>
      <Head>
        ...
        <meta key="og-image" property="og:image" content="https://www.1solutions.biz/images/og-google-ai-seo.jpg" />
        <meta key="og-image-w" property="og:image:width" content="1200" />
        <meta key="og-image-h" property="og:image:height" content="630" />
        <meta key="og-image-type" property="og:image:type" content="image/jpeg" />
        <meta property="og:image:alt" content="1Solutions Google AI SEO" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:image" content="https://www.1solutions.biz/images/og-google-ai-seo.jpg" />
        <meta name="twitter:image:alt" content="1Solutions Google AI SEO" />
        ...
        <style>{`
          ...
          @media(max-width:768px){
            .gais-svc,.gais-faq,.gais-cta,.gais-related{padding:60px 20px}
      ...
      <ServiceHero
        ...
        title={<>Google AI SEO Services - <AuroraText>Dominate Google AI Overviews</AuroraText></>}
        subtext="Google AI Overviews now appear at the top of search results for millions of queries — above every traditional ranking. We optimise your content to be cited in Google's AI-generated answers, not buried below them."
        primaryCta={{ label: 'Get a Free Consultation', href: '#contact' }}
        secondaryCta={{ label: 'View Services', href: '#services' }}
        stats={[
          { label: 'AI Overview Citations Won', value: '800', suffix: '+' },
          { label: 'Avg Impression Increase', value: '62', suffix: '%' },
          { label: 'Years Google SEO Experience', value: '15', suffix: '+' },
