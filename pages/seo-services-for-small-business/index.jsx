  ...
  return (
    <>
      <Head>
        ...
        <meta key="og-image" property="og:image" content="https://www.1solutions.biz/images/og-seo-services-for-small-business.jpg" />
        <meta key="og-image-w" property="og:image:width" content="1200" />
        <meta key="og-image-h" property="og:image:height" content="630" />
        <meta key="og-image-type" property="og:image:type" content="image/jpeg" />
        <meta property="og:image:alt" content="1Solutions SEO Services for Small Business — affordable SEO for growing businesses" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:image" content="https://www.1solutions.biz/images/og-seo-services-for-small-business.jpg" />
        <meta name="twitter:image:alt" content="1Solutions SEO Services for Small Business — affordable SEO for growing businesses" />
        ...
        <style>{`
          ...
          .smbbiz-bc a:hover{color:#16A34A}.smbbiz-bc span{color:#d1d5db}
          ...
          @media(max-width:768px){.smbbiz-svc,.smbbiz-inc,.smbbiz-proc,.smbbiz-why,.smbbiz-faq,.smbbiz-cta{padding:60px 24px}.smbbiz-grid{grid-template-columns:1fr}.smbbiz-why-grid{grid-template-columns:1fr}.smbbiz-step{grid-template-columns:56px 1fr}.smbbiz-btns{flex-direction:column;align-items:center}}
