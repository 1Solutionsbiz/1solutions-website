  ...
  return (
    <>
      <Head>
        ...
        <meta key="og-image" property="og:image" content="https://www.1solutions.biz/images/og-drupal-development-company.jpg" />
        <meta key="og-image-w" property="og:image:width" content="1200" />
        <meta key="og-image-h" property="og:image:height" content="630" />
        <meta key="og-image-type" property="og:image:type" content="image/jpeg" />
        <meta property="og:image:alt" content="1Solutions Drupal Development Company" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:image" content="https://www.1solutions.biz/images/og-drupal-development-company.jpg" />
        <meta name="twitter:image:alt" content="1Solutions Drupal Development Company" />
        <style>{`
          .dr-page {
          ...
          .dr-aurora { position:absolute; inset:-15%; z-index:0; pointer-events:none; filter:blur(70px) saturate(150%); animation:dr-aurora-drift 20s ease-in-out infinite alternate; }
          .dr-aurora-b1 { position:absolute; left:20%; top:30%; width:65%; height:65%; border-radius:50%; background:radial-gradient(circle at center,rgba(15,52,96,0.28) 0%,transparent 70%); transform:translate(-50%,-50%); }
          .dr-aurora-b2 { position:absolute; left:78%; top:22%; width:48%; height:48%; border-radius:50%; background:radial-gradient(circle at center,rgba(217,119,6,0.20) 0%,transparent 70%); transform:translate(-50%,-50%); }
          .dr-aurora-b3 { position:absolute; left:50%; top:82%; width:55%; height:55%; border-radius:50%; background:radial-gradient(circle at center,rgba(26,82,118,0.16) 0%,transparent 70%); transform:translate(-50%,-50%); }
          @keyframes dr-aurora-drift { 0%{transform:translate3d(0,0,0) scale(1)} 100%{transform:translate3d(-4%,3%,0) scale(1.10)} }
          ...
          .dr-section-title { font-size:48px;font-weight:900;line-height:1.15;letter-spacing:-1px;background:linear-gradient(135deg,#4f46e5,#7c3aed,#a855f7,#ec4899,#3b82f6,#06b6d4,#4f46e5);background-size:300% 300%;animation:aurora-text 6s ease infinite;-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;color:transparent;margin-bottom:10px; }
          ...
          .dr-plans-grid { display:grid;grid-template-columns:repeat(4,1fr);gap:20px;align-items:start; }
          .dr-pcard { display:flex;flex-direction:column;height:100%;padding:30px 26px;border-radius:20px;border:1.5px solid rgba(15,52,96,0.12);background:rgba(255,255,255,0.80);backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px);position:relative; }
          .dr-pcard--feat { border-color:rgba(217,119,6,0.40);background:linear-gradient(180deg,rgba(254,243,199,0.35) 0%,rgba(255,255,255,0.90) 100%);box-shadow:0 0 60px rgba(217,119,6,0.12),0 8px 40px rgba(15,52,96,0.08); }
          .dr-pcard-pop { position:absolute;top:-13px;left:50%;transform:translateX(-50%);padding:4px 14px;border-radius:100px;background:linear-gradient(90deg,#0F3460,#1a5276 50%,#D97706);color:#fff;font-size:10px;font-weight:800;letter-spacing:0.08em;text-transform:uppercase;white-space:nowrap;box-shadow:0 4px 16px rgba(217,119,6,0.28); }
          .dr-pcard-badge { display:inline-block;font-size:10px;font-weight:700;letter-spacing:0.10em;text-transform:uppercase;color:#6B7280;background:rgba(15,52,96,0.06);padding:4px 12px;border-radius:100px;margin-bottom:14px; }
          .dr-pcard-name { display:block;font-size:17px;font-weight:800;color:#0F3460;margin-bottom:10px;line-height:1.3; }
          .dr-pcard--feat .dr-pcard-name { color:#b45309; }
          .dr-pcard-blurb { font-size:13px;color:#4A6080;line-height:1.7;margin:0 0 20px; }
          .dr-pcard-features { list-style:none;padding:0;margin:0 0 24px;flex:1; }
          .dr-pcard-features li { padding:8px 0;border-top:1px dashed rgba(15,52,96,0.10);font-size:13.5px;color:#374151;display:flex;align-items:flex-start;gap:8px; }
          .dr-pcard-features li::before { content:'✓';color:#16a34a;font-weight:700;flex-shrink:0; }
          .dr-pcard-cta { display:block;padding:12px 20px;background:rgba(15,52,96,0.07);border:1.5px solid rgba(15,52,96,0.18);border-radius:50px;color:#0F3460;font-size:13.5px;font-weight:700;text-decoration:none;text-align:center;transition:all 0.2s;margin-top:auto; }
          .dr-pcard-cta:hover { background:rgba(15,52,96,0.12);transform:translateY(-1px);text-decoration:none; }
          .dr-pcard-cta--feat { background:linear-gradient(135deg,#0F3460,#1a5276);border-color:transparent;color:#fff;box-shadow:0 4px 20px rgba(15,52,96,0.28); }
          .dr-pcard-cta--feat:hover { background:linear-gradient(135deg,#0a2444,#0F3460);box-shadow:0 6px 28px rgba(15,52,96,0.38);color:#fff; }
          @media(max-width:1024px){ .dr-plans-grid { grid-template-columns:repeat(2,1fr); } }
          @media(max-width:600px){ .dr-plans-grid { grid-template-columns:1fr; } }
          ...
          .dr-faq-heading { font-size:48px;font-weight:900;line-height:1.15;letter-spacing:-1px;background:linear-gradient(135deg,#4f46e5,#7c3aed,#a855f7,#ec4899,#3b82f6,#06b6d4,#4f46e5);background-size:300% 300%;animation:aurora-text 6s ease infinite;-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;color:transparent;margin:0 0 36px; }
          ...
          .dr-related-title { font-size:48px;font-weight:900;line-height:1.15;letter-spacing:-1px;background:linear-gradient(135deg,#4f46e5,#7c3aed,#a855f7,#ec4899,#3b82f6,#06b6d4,#4f46e5);background-size:300% 300%;animation:aurora-text 6s ease infinite;-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;color:transparent;margin:0 0 16px; }
      ...
      <div className="dr-page">
        <div className="dr-aurora" aria-hidden="true">
          <div className="dr-aurora-b1" />
          <div className="dr-aurora-b2" />
          <div className="dr-aurora-b3" />
        </div>

        {/* ── HERO ── */}
        <ServiceHero
          eyebrow="Expert Drupal Development Company"
          title={<>Drupal Development Services - <AuroraText>Enterprise CMS Built for Scale</AuroraText></>}
          subtext="From custom Drupal 10 websites and headless architectures to complex migrations and Drupal Commerce stores - 1Solutions delivers secure, scalable Drupal solutions for enterprises, governments, and fast-growing businesses across the US, Canada, and Australia."
          primaryCta={{ label: 'Get a Free Consultation Now', href: '#contact' }}
          stats={[
            { label: 'Drupal Projects', value: '150', suffix: '+' },
            { label: 'Drupal Experts', value: '20', suffix: '+' },
        ...
        <section className="dr-engage-section" id="engagement">
          <div className="dr-engage-inner">
            ...
            <div className="dr-plans-grid">
              <article className="dr-pcard">
                <span className="dr-pcard-badge">One-time</span>
                <span className="dr-pcard-name">Fixed-Price Project</span>
                <p className="dr-pcard-blurb">Defined scope &amp; budget — ideal for clearly-scoped builds with a fixed timeline and deliverables.</p>
                <ul className="dr-pcard-features">
                ...
                <a href="#contact" className="dr-pcard-cta">Get a Quote</a>
              </article>
              <article className="dr-pcard">
                <span className="dr-pcard-badge">Flexible</span>
                <span className="dr-pcard-name">Time &amp; Materials</span>
                <p className="dr-pcard-blurb">Scale with evolving requirements — pay for what's delivered, adjust scope any sprint.</p>
                <ul className="dr-pcard-features">
                  <li>Shared specialist team</li>
              ...
              <article className="dr-pcard dr-pcard--feat">
                <span className="dr-pcard-pop">✦ Most Popular</span>
                <span className="dr-pcard-name">Dedicated Team</span>
                <p className="dr-pcard-blurb">Your extended team — specialists embedded in your workflow, committed to your long-term growth.</p>
                <ul className="dr-pcard-features">
                ...
                <a href="#contact" className="dr-pcard-cta dr-pcard-cta--feat">Get Started</a>
              </article>
              <article className="dr-pcard">
                <span className="dr-pcard-badge">Cost-efficient</span>
                <span className="dr-pcard-name">Offshore Model</span>
                <p className="dr-pcard-blurb">Maximum ROI with our expert offshore team — senior-level quality at budget-friendly rates.</p>
                <ul className="dr-pcard-features">
          ...
          <div className="dr-contact-container">
            ...
            <div className="dr-contact-right">
              <div className="dr-form-box">
                <h3>Contact Us</h3>
                <form className="dr-contact-form" onSubmit={_sfSubmit}>
                  <div className="dr-form-row">
                    <div className="dr-form-group"><label>Full Name*</label><input name="sf-name" type="text" placeholder="Full Name*" required /></div>
                    <div className="dr-form-group"><label>Business Email*</label><input type="email" name="sf-email" placeholder="Business Email Address*" required /></div>
                  </div>
                  <div className="dr-form-row">
                    ...
                    <div className="dr-form-group"><label>Organization*</label><input name="sf-company" type="text" placeholder="Organization / Institution*" required /></div>
                  </div>
                  <div className="dr-form-group full"><label>Message*</label><textarea name="sf-message" placeholder="Describe your Drupal project requirements..." rows={6} required /></div>
