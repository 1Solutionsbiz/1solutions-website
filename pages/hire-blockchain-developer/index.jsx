    ...
    <>
      ...
      <div className="hbc-page">
        ...
        <div className="hbc-fb"><h3>Tell Us Your Blockchain Requirements</h3><form className="hbc-form" onSubmit={e => e.preventDefault()}>
          ...
          <div className="hbc-fr"><div className="hbc-fg"><label htmlFor="hbc-co">Company Name</label><input id="hbc-co" type="text" placeholder="Your company" /></div><div className="hbc-fg"><label htmlFor="hbc-ph">Phone / WhatsApp *</label><input id="hbc-ph" type="tel" placeholder="+1 555 000 0000" required /></div></div>
