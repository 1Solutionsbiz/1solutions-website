    ...
    try {
      ...
      const res = await fetch('/api/contact', {
        ...
        body: JSON.stringify({
          ...
          source: 'Hire Blockchain Developer', consent: true, recaptchaToken: token,
        }),
      });
  ...
  return (
    <>
      ...
      <div className="hbc-page">
        ...
        <div className="hbc-fb"><h3>Tell Us Your Blockchain Requirements</h3><form className="hbc-form" onSubmit={_sfSubmit}>
          <div className="hbc-fr"><div className="hbc-fg"><label htmlFor="hbc-nm">Full Name *</label><input name="sf-name" id="hbc-nm" type="text" placeholder="Your name" required /></div><div className="hbc-fg"><label htmlFor="hbc-em">Work Email *</label><input id="hbc-em" type="email" name="sf-email" placeholder="you@company.com" required /></div></div>
          <div className="hbc-fr"><div className="hbc-fg"><label htmlFor="hbc-co">Company Name</label><input name="sf-company" id="hbc-co" type="text" placeholder="Your company" /></div><div className="hbc-fg"><label htmlFor="hbc-ph">Phone / WhatsApp *</label><input id="hbc-ph" type="tel" name="sf-phone" placeholder="+1 555 000 0000" required /></div></div>
          ...
          <div className="hbc-fg full"><label htmlFor="hbc-ms">Project Description *</label><textarea name="sf-message" id="hbc-ms" rows={4} placeholder="Describe your smart contract or Web3 project, chain, security requirements, TVL expectations (if DeFi), timeline, and any existing contracts or architecture..." required /></div>
