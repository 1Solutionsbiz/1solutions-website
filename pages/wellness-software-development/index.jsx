    ...
    try {
      ...
      const res = await fetch('/api/contact', {
        ...
        body: JSON.stringify({
          ...
          source: 'Wellness Software Development', consent: true, recaptchaToken: token,
        }),
      });
  ...
  return (
    <>
      <Head>
        ...
        <meta key="og-image" property="og:image" content="https://www.1solutions.biz/images/og-wellness-software-development.jpg" />
        <meta key="og-image-w" property="og:image:width" content="1200" />
        <meta key="og-image-h" property="og:image:height" content="630" />
        <meta key="og-image-type" property="og:image:type" content="image/jpeg" />
        <meta property="og:image:alt" content="1Solutions Wellness Software Development" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:image" content="https://www.1solutions.biz/images/og-wellness-software-development.jpg" />
        <meta name="twitter:image:alt" content="1Solutions Wellness Software Development" />
        ...
        <style>{`
          ...
          .wls-ri h2{font-size:30px;font-weight:900;background:linear-gradient(135deg,#4f46e5,#7c3aed,#a855f7,#ec4899,#3b82f6,#06b6d4,#4f46e5);background-size:300% 300%;animation:aurora-text 6s ease infinite;-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;margin:10px 0 10px}
      ...
      <div className="wls-page">
        ...
        <div className="wls-fb"><h3>Tell Us About Your Wellness Project</h3><form className="wls-form" onSubmit={_sfSubmit}><div className="wls-fr"><div className="wls-fg"><label>Full Name *</label><input name="sf-name" type="text" placeholder="Your name" required /></div><div className="wls-fg"><label>Work Email *</label><input type="email" name="sf-email" placeholder="you@company.com" required /></div></div><div className="wls-fr"><div className="wls-fg"><label>Company</label><input name="sf-name" type="text" placeholder="Company name" /></div><div className="wls-fg"><label>Phone / WhatsApp *</label><input type="tel" name="sf-phone" placeholder="+1 555 000 0000" required /></div></div><div className="wls-fg full"><label>Type of Wellness Platform *</label><select required><option value="">Select...</option><option>Mental Health & Therapy App</option><option>Fitness & Personal Coaching Platform</option><option>Corporate Wellness Portal</option><option>Nutrition & Meal Planning App</option><option>Meditation & Mindfulness App</option><option>Sleep Tracking & Improvement Platform</option><option>Chronic Disease Self-Management App</option><option>Wellness Marketplace Platform</option><option>Wearable & EHR Integration</option><option>Wellness Analytics Dashboard</option><option>Other</option></select></div><div className="wls-fg full"><label>Project Description *</label><textarea name="sf-message" rows={4} placeholder="Describe your wellness software project - target users, core features, compliance requirements (HIPAA, GDPR), wearable integration needed, and go-live timeline..." required /></div><div className="wls-co"><input type="checkbox" required /><label>I agree to the <Link href="/privacy-policy/">Privacy Policy</Link>. Details are treated confidentially.</label></div><button type="submit" className="wls-sub">Get a Wellness Tech Proposal →</button>
                  {_sfSt === 'success' && <div style={{marginTop:'12px',padding:'12px 16px',background:'#f0fdf4',border:'1px solid #86efac',borderRadius:'8px',color:'#166534',fontSize:'0.875rem',fontWeight:500}}>&#10003; Message sent! We&apos;ll get back to you within 24 hours.</div>}{_sfSt === 'error' && <div style={{marginTop:'12px',padding:'12px 16px',background:'#fef2f2',border:'1px solid #fca5a5',borderRadius:'8px',color:'#991b1b',fontSize:'0.875rem',fontWeight:500}}>Something went wrong. Please email info@1solutions.biz</div>}</form></div></div></section>
        ...
        <section className="wls-rel"><div className="wls-ri"><span className="wls-sey">Related Services</span><h2>Related Industry & Technology Services</h2><hr /><div className="wls-rts">{[['/healthcare-software-development/','Healthcare Software','wls-ra'],['/mobile-app-development/','Mobile App Development','wls-rb'],['/saas-application-development-company/','SaaS Development','wls-rc'],['/social-media-app-development-company/','Social Media Apps','wls-rd'],['/it-outsourcing-services/','IT Outsourcing','wls-ra'],['/offshore-development-company/','Offshore Development','wls-rb'],['/ai-solutions/','AI/ML Development','wls-rc'],['/elearning-software-development-services/','eLearning Software','wls-rd']].map(([hr, lb, cl]) => (<Link key={hr} href={hr} className={`wls-rt ${cl}`}>{lb}</Link>))}</div></div></section>
      </div>
    </>
  );
}
