...
const PROJECTS = [
  ...
  { id: 'empor', title: 'Empor Marcom', category: 'Web Development', industry: 'B2B Marketing', tech: ['WordPress', 'Custom Theme', 'UI/UX Design'], desc: 'Agency website for a pan-India B2B marketing firm — delivering lead generation, telemarketing, virtual events, and content syndication for enterprise clients.', image: '/images/portfolio/empor.png' },
  { id: 'novanttum', title: 'Novanttum', category: 'Web Development', industry: 'Alternative Investments', tech: ['WordPress', 'Custom Theme', 'UI/UX Design'], desc: 'Investment platform for Novanttum Alternatives — a SEBI-registered AIF offering private credit, equity, and structured finance to high-potential businesses.', image: '/images/portfolio/novanttum.png' },
  ...
  { id: 'youngmonk', title: 'Young Monk', category: 'Web Development', industry: 'Public Relations', tech: ['WordPress', 'Custom Theme', 'UI/UX Design'], desc: 'Agency website for Young Monk — a New Delhi-based PR and communications firm specialising in Sports, Entertainment, and Change Agents.', image: '/images/portfolio/youngmonk.png' },
  { id: 'greycellpr', title: 'Grey Cell PR', category: 'Web Development', industry: 'Public Relations', tech: ['WordPress', 'Custom Theme', 'UI/UX Design'], desc: 'Corporate website for Grey Cell PR — a Delhi-based branding and communications consultancy delivering strategic media relations and corporate brand management.', image: '/images/portfolio/greycellpr.png' },
    ...
    <>
      <Head>
        ...
        <style>{`
          ...
          .cs-hero-glow {
            position: absolute; top: -120px; right: -120px; width: 600px; height: 600px;
            border-radius: 50%;
            background: radial-gradient(circle, rgba(17,65,113,0.5) 0%, transparent 65%);
            pointer-events: none;
          }
          .cs-hero-inner {
          ...
          .cs-breadcrumb a { color: rgba(255,255,255,0.38); text-decoration: none; }
          .cs-breadcrumb a:hover { color: #FE9700; }
          .cs-breadcrumb-sep { color: rgba(255,255,255,0.2); }
          .cs-breadcrumb-current { color: #FE9700; }
          .cs-hero-label {
            display: inline-flex; align-items: center; gap: 8px;
            color: #FE9700; font-size: 12px; font-weight: 700;
            letter-spacing: 0.18em; text-transform: uppercase; margin-bottom: 24px;
          }
          .cs-hero-label-line {
            display: inline-block; width: 32px; height: 2px; background: #FE9700;
          }
          .cs-hero-title {
          ...
          .cs-hero-title em { font-style: normal; color: #FE9700; }
          .cs-hero-sub {
            font-size: 1.05rem; color: rgba(255,255,255,0.55);
            max-width: 520px; line-height: 1.8; margin-bottom: 48px;
          }
          .cs-hero-actions { display: flex; align-items: center; gap: 20px; flex-wrap: wrap; margin-bottom: 80px; }
          .cs-hero-btn-primary {
          ...
          .cs-hero-btn-primary:hover { background: #e08600; }
          ...
          .cs-hero-btn-secondary:hover { color: #fff; border-color: rgba(255,255,255,0.6); }
          ...
          .cs-featured-header {
            max-width: 1200px; margin: 0 auto; padding: 80px 48px 0;
            display: flex; align-items: flex-end; justify-content: space-between; gap: 24px;
          }
          .cs-featured-header-left {}
          .cs-section-kicker {
            font-size: 11px; font-weight: 700; letter-spacing: 0.18em;
            text-transform: uppercase; color: #FE9700; margin-bottom: 12px;
          }
          .cs-section-title {
            font-size: clamp(1.4rem, 2vw, 1.75rem); font-weight: 800;
            color: #080F1E; letter-spacing: -0.02em; line-height: 1.2;
          }
          .cs-section-sub { font-size: 14px; color: #6b7280; margin-top: 8px; max-width: 420px; }
          ...
          .cs-case-title {
            font-size: clamp(1.5rem, 2vw, 2rem); font-weight: 800;
            color: #080F1E; line-height: 1.2; margin-bottom: 16px;
            letter-spacing: -0.02em;
          }
          .cs-case-desc {
          ...
          .cs-case-outcomes {
            ...
            padding: 20px 0; border-top: 1px solid #f1f2f4;
          }
          .cs-case-outcome-val {
            font-size: 1.6rem; font-weight: 800; color: #080F1E;
          ...
          .cs-case-tags { display: flex; flex-wrap: wrap; gap: 6px; margin-bottom: 28px; }
          .cs-case-tag {
          ...
          .cs-case-link {
            ...
            text-decoration: none; color: #080F1E;
            border-bottom: 2px solid #FE9700; padding-bottom: 2px;
            width: fit-content;
          ...
          .cs-case-item.reverse .cs-case-text { order: 2; }
          .cs-case-item.reverse .cs-case-visual { order: 1; }
          ...
          .cs-filter-tab:hover { color: #080F1E; }
          .cs-filter-tab.active { color: #080F1E; border-bottom-color: #FE9700; }
          .cs-proj-meta {
          ...
          .cs-proj-card:hover {
            box-shadow: 0 8px 32px rgba(8,15,30,0.1), 0 0 0 1px rgba(8,15,30,0.06);
          ...
          .cs-proj-name {
            font-size: 15px; font-weight: 700; color: #080F1E;
          ...
          .cs-proj-link {
            ...
            font-size: 12px; font-weight: 700; color: #080F1E;
          ...
          .cs-cta-kicker {
            ...
            text-transform: uppercase; color: #FE9700; margin-bottom: 20px;
          }
          .cs-cta-title {
          ...
          .cs-cta-sub {
            ...
            line-height: 1.8; margin: 0 auto 44px; max-width: 480px;
          }
          ...
          .cs-cta-btn-secondary {
            ...
            padding: 15px 32px; border-radius: 6px;
            font-size: 14px; font-weight: 700; letter-spacing: 0.02em;
            text-decoration: none; border: 1.5px solid rgba(255,255,255,0.14);
          ...
          @media (max-width: 860px) {
            ...
            .cs-featured-header { padding: 60px 24px 0; }
            .cs-case-item { grid-template-columns: 1fr; gap: 40px; padding: 56px 24px; }
            .cs-case-item.reverse .cs-case-text { order: 0; }
            .cs-case-item.reverse .cs-case-visual { order: 0; }
            .cs-projects-inner { padding: 0 24px; }
            .cs-cta { padding: 72px 24px; }
          }
          @media (max-width: 640px) {
            .cs-hero { padding: 80px 0 0; }
            .cs-stat-item { padding: 24px; }
            .cs-proj-grid { grid-template-columns: 1fr; }
            .cs-projects { padding: 56px 0 64px; }
            .cs-case-outcomes { gap: 20px; flex-wrap: wrap; }
      ...
      <section className="cs-hero">
        ...
        <div className="cs-hero-inner">
          ...
          <h1 className="cs-hero-title">
            Work that has<br /><em>defined</em> brands,<br />built businesses.
          </h1>
          <p className="cs-hero-sub">
            15+ years of delivering measurable outcomes for clients across the US, Canada, Australia, the Middle East, and India.
          </p>
          <div className="cs-hero-actions">
            <Link href="/contact-us" className="cs-hero-btn-primary">
              Start a Project
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
            </Link>
            <Link href="/portfolio" className="cs-hero-btn-secondary">
              View Full Portfolio
      ...
      <div className="cs-projects">
        <div className="cs-projects-inner">
          <div className="cs-projects-top">
            <div className="cs-projects-top-left">
              <p className="cs-section-kicker">Our Portfolio</p>
              <h2 className="cs-section-title">All Projects</h2>
            ...
            {filtered.map((p, i) => (
              <div key={p.id} className="cs-proj-card">
                <div className="cs-proj-thumb">
                  ...
                  {p.featured && <span className="cs-proj-featured-dot">Featured</span>}
                  <span className="cs-proj-cat">{p.category}</span>
                </div>
      ...
      <section className="cs-cta">
        ...
        <div className="cs-cta-inner">
          ...
          <h2 className="cs-cta-title">Ready to build your<br />success story?</h2>
