...
const FEATURED = {
  ...
  desc: 'Built a professional corporate website for a Gurgaon-based financial advisory firm specialising in Trade Financing, Debt Advisory, Equity Advisory, and Credit Rating — then grew their professional reach with a targeted LinkedIn brand programme.',
...
const PROJECTS = [
  { id: 'aiplusstore',       title: 'AI+ Store',                    category: 'eCommerce',        industry: 'Consumer Electronics',   tech: ['Shopify', 'Liquid', 'UI/UX Design'],           desc: 'Full-featured Shopify store for AI+ SmartPhones — 5G smartphones, NovaPods, and NovaWatches across India.',                                        image: '/images/portfolio/aiplusstore.jpg',         url: 'https://aiplusstore.com/',           featured: true },
  { id: 'keiyura',           title: 'Keiyura',                      category: 'eCommerce',        industry: 'Fashion & Jewellery',     tech: ['Shopify', 'Liquid', 'UI/UX Design'],           desc: 'Elegant Shopify store for a handcrafted jewellery brand with lookbooks, curated collections, and a storytelling-led shopping experience.',           image: '/images/portfolio/keiyura.jpg',             url: 'https://keiyura.com/'                          },
  { id: 'shopsamsin',        title: 'Samsin',                       category: 'eCommerce',        industry: 'Fashion & Apparel',       tech: ['Shopify', 'Liquid', 'Email Marketing'],        desc: 'Minimalist Shopify store for a streetwear label with VIP subscriber access and flash-sale promotions.',                                             image: '/images/portfolio/shopsamsin.jpg',          url: 'https://shopsamsin.com/'                       },
  ...
  { id: 'foreverring',       title: 'Forever Ring',                 category: 'eCommerce',        industry: 'Fashion & Jewellery',     tech: ['Shopify', 'Liquid', 'UI/UX Design'],           desc: 'Sophisticated Shopify store for a Canadian fine jewellery brand with clean product presentation and seamless checkout.',                             image: '/images/portfolio/foreverring.jpg',         url: 'https://www.foreverring.ca/'                   },
  ...
  { id: 'rngfoundation',     title: 'RNG Foundation Awards',        category: 'Web Development',  industry: 'Media & Journalism',      tech: ['WordPress', 'Custom Theme', 'UI/UX Design'],   desc: "Award portal for India's most prestigious journalism honours across 14 categories — Indian Express Group with EY as knowledge partner.",             image: '/images/portfolio/rngfoundation.webp',      url: 'https://rngfoundation.com/awards/'             },
  ...
  { id: 'febestbanksawards', title: 'FE Best Banks Awards',         category: 'Web Development',  industry: 'Banking & Finance',       tech: ['WordPress', 'Custom Theme', 'UI/UX Design'],   desc: "Award portal for the Financial Express Best Banks Awards — India's highest honour in banking excellence.",                                          image: '/images/portfolio/febestbanksawards.png'                                                                 },
  ...
  { id: 'runaya',            title: 'Runaya',                       category: 'Web Development',  industry: 'Manufacturing',           tech: ['WordPress', 'Custom Theme', 'UI/UX Design'],   desc: "India's first zero-waste aluminium processing facility — recovering 16,000 MT of green aluminium annually.",                                       image: '/images/portfolio/runaya.png'                                                                            },
  ...
  { id: 'zincfootball',      title: 'Zinc Football',                category: 'Web Development',  industry: 'Sports & Education',      tech: ['WordPress', 'Custom Theme', 'UI/UX Design'],   desc: "India's first technology-driven grassroots football initiative backed by Hindustan Zinc, training 350+ children.",                                  image: '/images/portfolio/zincfootball.png'                                                                      },
  { id: 'playaorthodontics', title: 'Playa Orthodontics',           category: 'Web Development',  industry: 'Healthcare',              tech: ['WordPress', 'Custom Theme', 'UI/UX Design'],   desc: 'Los Angeles orthodontic clinic — Invisalign, braces, treatments for all ages, and online consultation booking.',                                   image: '/images/portfolio/playaorthodontics.png'                                                                 },
  ...
  { id: 'phdcci',            title: 'PHDCCI',                       category: 'Web Development',  industry: 'Trade & Industry',        tech: ['WordPress', 'Custom Theme', 'UI/UX Design'],   desc: "India's apex industry body with 121+ years of legacy in trade promotion and policy advocacy.",                                                     image: '/images/portfolio/phdcci.png'                                                                            },
  { id: 'defenceaviationpost',title: 'Defence Aviation Post',       category: 'Web Development',  industry: 'Defence & Media',         tech: ['WordPress', 'Custom Theme', 'UI/UX Design'],   desc: "Defence and military news portal covering aerospace, missile systems, and global security developments.",                                           image: '/images/portfolio/defenceaviationpost.png'                                                               },
...
.cs-feat-left {}
.cs-feat-num {
  font-size: 13px; font-weight: 700; color: #BBBBBB;
  letter-spacing: 0.06em; display: block; margin-bottom: 10px;
}
.cs-feat-title {
  font-size: clamp(1.9rem, 2.8vw, 2.6rem); font-weight: 800;
  color: #111; line-height: 1.18; letter-spacing: -0.025em;
  margin-bottom: 24px;
}
.cs-feat-desc {
...
.cs-feat-tag {
  ...
  border: 1.5px solid #222; border-radius: 50px;
  padding: 6px 18px; transition: background 0.2s, color 0.2s;
}
.cs-feat-tag:hover { background: #222; color: #fff; }
.cs-feat-link {
  display: inline-flex; align-items: center; gap: 8px;
  font-size: 14px; font-weight: 700; color: #fff;
  background: #0A1628;
  border: 2px solid #0A1628; border-radius: 50px;
  padding: 12px 28px; text-decoration: none;
  transition: background 0.2s, color 0.2s;
}
.cs-feat-link:hover { background: #FE9700; border-color: #FE9700; }
.cs-feat-right {}
.cs-feat-img {
...
.cs-work-inner { max-width: 1280px; margin: 0 auto; padding: 0 60px; }
.cs-work-head { margin-bottom: 40px; }
.cs-work-kicker {
  font-size: 11px; font-weight: 700; letter-spacing: 0.2em;
  text-transform: uppercase; color: #FE9700; margin-bottom: 10px;
}
.cs-work-h {
  font-size: clamp(1.6rem, 2.2vw, 2.1rem); font-weight: 800;
  color: #111; letter-spacing: -0.02em;
}

/* Filter tabs */
.cs-tabs {
  display: flex; border-bottom: 1.5px solid #E0E0E0;
...
.cs-tab.on { color: #111; border-bottom-color: #111; }
.cs-count { font-size: 12px; color: #AAA; margin: 16px 0 28px; }
.cs-count strong { color: #555; }
...
.cs-card-industry {
  ...
  letter-spacing: 0.12em; color: #AAAAAA; margin-bottom: 6px;
}
.cs-card-title {
...
.cs-card-tech { display: flex; flex-wrap: wrap; gap: 5px; margin-bottom: 14px; }
.cs-card-tech-tag {
...
/* ── CTA ── */
.cs-cta {
  background: #0A1628; padding: 96px 60px;
...
@media (max-width: 1024px) {
  ...
  .cs-feat-row { grid-template-columns: 1fr; gap: 40px; }
}
@media (max-width: 768px) {
  .cs-featured-inner,.cs-work-inner,.cs-cta { padding-left: 24px; padding-right: 24px; }
  .cs-featured { padding: 60px 0 72px; }
...
@media (max-width: 600px) {
  ...
  .cs-hero-inner { padding: 0 24px; }
        ...
        <div className="cs-featured-inner">
          <div className="cs-feat-row">
            <div className="cs-feat-left">
              <span className="cs-feat-num">{FEATURED.num}</span>
              <h2 className="cs-feat-title">{FEATURED.title}</h2>
              <p className="cs-feat-desc">{FEATURED.desc}</p>
              <div className="cs-feat-tags">
                {FEATURED.tags.map(t => (
                  <span key={t} className="cs-feat-tag">{t}</span>
                ))}
              </div>
              <Link href={FEATURED.url} className="cs-feat-link">
                Read Case Study
      ...
      {/* ── ALL PROJECTS ── */}
      <section className="cs-work">
        <div className="cs-work-inner">
          <div className="cs-work-head">
            <p className="cs-work-kicker">Our Portfolio</p>
            <h2 className="cs-work-h">Explore Our Work</h2>
          </div>
            ...
            {filtered.map((p, i) => (
              <div key={p.id} className="cs-card">
                <div className="cs-card-thumb">
                  ...
                  {p.featured && <span className="cs-card-featured">Featured</span>}
