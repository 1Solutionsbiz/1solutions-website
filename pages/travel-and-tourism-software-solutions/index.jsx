  ...
  return (
    <>
      ...
      <div className="tt-page">
        ...
        <div className="tt-fb"><h3>Tell Us About Your Travel Platform</h3><form className="tt-form" onSubmit={_sfSubmit}><div className="tt-fr"><div className="tt-fg"><label>Full Name *</label><input name="sf-name" type="text" placeholder="Your name" required /></div><div className="tt-fg"><label>Work Email *</label><input type="email" name="sf-email" placeholder="you@company.com" required /></div></div><div className="tt-fr"><div className="tt-fg"><label>Company</label><input name="sf-company" type="text" placeholder="Your company" /></div><div className="tt-fg"><label>Phone / WhatsApp</label><input type="tel" name="sf-phone" placeholder="+1 555 000 0000" /></div></div><div className="tt-fg full"><label>Type of Travel Platform *</label><select required><option value="">Select...</option><option>OTA / Online Booking Engine</option><option>Hotel PMS / Property Management System</option><option>Tour Operator / DMC Software</option><option>Travel Mobile App</option><option>Corporate / B2B Travel Management</option><option>Dynamic Pricing Engine</option><option>Travel CRM / Loyalty Platform</option><option>GDS / API Integration</option><option>Other</option></select></div><div className="tt-fg full"><label>Project Description *</label><textarea name="sf-message" rows={4} placeholder="Describe your travel technology project - type of platform, current system (if any), key features needed, target markets, and timeline..." required /></div><div className="tt-co"><input type="checkbox" required /><label>I agree to the <Link href="/privacy-policy">Privacy Policy</Link>. Details are treated confidentially.</label></div><button type="submit" className="tt-sub">Get a Travel Platform Proposal →</button>
