    ...
    <>
      <Head>
        ...
        <style>{`
          ...
          @media(max-width:1100px){.sh-breadcrumb{padding:16px 48px 0}}
          @media(max-width:900px){.sh-breadcrumb{padding:14px 32px 0}}
          @media(max-width:480px){.sh-breadcrumb{padding:12px 20px 0}}
      ...
      <div className="sh-page">
        <ServiceHero
          eyebrow="Hire Shopify Developer · Liquid · Shopify Plus · Hydrogen"
          title={<>Hire Expert <AuroraText>Shopify Developers</AuroraText></>}
          subtext="Custom Liquid themes, Shopify Plus, private app development, WooCommerce migrations, and Headless Shopify with Hydrogen - backed by 15+ years of eCommerce expertise."
          primaryCta={{ label: 'Hire a Shopify Developer', href: '#contact' }}
          stats={[
            { label: 'Shopify Stores Built', value: '80', suffix: '+' },
            { label: 'Years eCommerce', value: '15', suffix: '+' },
            { label: 'Revenue Processed', value: '50', suffix: 'M+' },
        ...
        <section className="sh-related">
          <div className="sh-related-inner">
            ...
            <div className="sh-rtags">
              {[['/woocommerce-development-company/','WooCommerce Development','sh-rtag-violet'],['/magento-development-company/','Magento Development','sh-rtag-amber'],['/openCart-development-company/','OpenCart Development','sh-rtag-teal'],['/ecommerce-website-development-services/','eCommerce Development','sh-rtag-amber'],['/hire-wordpress-developer/','Hire WordPress Developer','sh-rtag-blue'],['/hire-reactjs-developer/','React.js Development','sh-rtag-blue'],['/next-js-development-company/','Next.js Development','sh-rtag-violet'],['/website-support-maintenance-services/','Website Maintenance','sh-rtag-teal'],['/seo-services/','SEO Services','sh-rtag-green'],['/wordpress-support-and-maintenance-services/','WordPress Maintenance','sh-rtag-green']].map(([href, label, cls]) => (
