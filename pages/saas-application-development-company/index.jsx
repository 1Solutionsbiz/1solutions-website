    ...
    try {
      ...
      const res = await fetch('/api/contact', {
        ...
        body: JSON.stringify({
          ...
          source: 'Saas Application Development Company', consent: true, recaptchaToken: token,
        }),
      });
    ...
    <>
      <Head>
        ...
        <style>{`
          ...
          .sas-ri h2{font-size:30px;font-weight:900;background:linear-gradient(135deg,#4f46e5,#7c3aed,#a855f7,#ec4899,#3b82f6,#06b6d4,#4f46e5);background-size:300% 300%;animation:aurora-text 6s ease infinite;-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;margin:10px 0 10px}
      ...
      <div className="sas-page">
        ...
        <div className="sas-fb"><h3>Tell Us About Your SaaS Product</h3><form className="sas-form" onSubmit={_sfSubmit}><div className="sas-fr"><div className="sas-fg"><label>Full Name *</label><input name="sf-name" type="text" placeholder="Your name" required /></div><div className="sas-fg"><label>Work Email *</label><input type="email" name="sf-email" placeholder="you@company.com" required /></div></div><div className="sas-fr"><div className="sas-fg"><label>Company</label><input name="sf-name" type="text" placeholder="Company name" /></div><div className="sas-fg"><label>Phone / WhatsApp *</label><input type="tel" name="sf-phone" placeholder="+1 555 000 0000" required /></div></div><div className="sas-fg full"><label>SaaS Category *</label><select required><option value="">Select...</option><option>HR / Payroll SaaS</option><option>CRM / Sales SaaS</option><option>Project Management</option><option>Marketing Automation</option><option>LMS / EdTech SaaS</option><option>FinTech SaaS</option><option>Field Service Management</option><option>Customer Support / Helpdesk</option><option>API-First / Developer Tools</option><option>White-Label SaaS Platform</option><option>Other B2B SaaS</option><option>B2C SaaS</option></select></div><div className="sas-fg full"><label>Project Description *</label><textarea name="sf-message" rows={4} placeholder="Describe your SaaS product - target users, core features, billing model (seat-based, usage-based, flat), integrations needed, and go-live timeline..." required /></div><div className="sas-co"><input type="checkbox" required /><label>I agree to the <Link href="/privacy-policy/">Privacy Policy</Link>. Details are treated confidentially.</label></div><button type="submit" className="sas-sub">Get a SaaS Architecture Proposal →</button>
        ...
        <section className="sas-rel"><div className="sas-ri"><span className="sas-sey">Related Services</span><h2>Related Industry & Technology Services</h2><hr /><div className="sas-rts">{[['/fintech-software-development-company/','FinTech Software','sas-ra'],['/healthcare-software-development/','Healthcare Software','sas-rb'],['/it-outsourcing-services/','IT Outsourcing','sas-rc'],['/offshore-development-company/','Offshore Development','sas-rd'],['/web-development/','Web Development','sas-ra'],['/mobile-app-development/','Mobile App Development','sas-rb'],['/ai-solutions/','AI/ML Development','sas-rc'],['/api-development/','API Development','sas-rd']].map(([hr, lb, cl]) => (<Link key={hr} href={hr} className={`sas-rt ${cl}`}>{lb}</Link>))}</div></div></section>
      </div>
    </>
  );
}
