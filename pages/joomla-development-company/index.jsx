    ...
    try {
      ...
      const res = await fetch('/api/contact', {
        ...
        body: JSON.stringify({
          ...
          source: 'Joomla Development Company', consent: true, recaptchaToken: token,
        }),
      });
  ...
  return (
    <>
      <Head>
        ...
        <meta key="og-image" property="og:image" content="https://www.1solutions.biz/images/og-joomla-development-company.jpg" />
        <meta key="og-image-w" property="og:image:width" content="1200" />
        <meta key="og-image-h" property="og:image:height" content="630" />
        <meta key="og-image-type" property="og:image:type" content="image/jpeg" />
        <meta property="og:image:alt" content="1Solutions Joomla Development" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:image" content="https://www.1solutions.biz/images/og-joomla-development-company.jpg" />
        <meta name="twitter:image:alt" content="1Solutions Joomla Development" />
        ...
        <style>{`
          ...
          .jo-related h2{font-size:34px;font-weight:900;background:linear-gradient(135deg,#4f46e5,#7c3aed,#a855f7,#ec4899,#3b82f6,#06b6d4,#4f46e5);background-size:300% 300%;animation:aurora-text 6s ease infinite;-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;margin:10px 0 12px}
      ...
      <div className="jo-page">
        ...
        <ServiceHero
          eyebrow="Joomla Development Company · Joomla 4.x & 5.x Experts · Security Hardening Included"
          title={<>Expert Joomla Development - <AuroraText>Custom Templates, Components &amp; Joomla 5 Upgrades</AuroraText></>}
          subtext="We build, upgrade, and maintain Joomla websites - custom templates from scratch, bespoke MVC components and plugins, multilingual portals, eCommerce, Joomla 3.x to 5.x upgrades, and security hardening. 15+ years of Joomla expertise for businesses worldwide."
          primaryCta={{ label: 'Start Your Joomla Project', href: '#contact' }}
          secondaryCta={{ label: 'View Engagement Models', href: '#engagement' }}
          stats={[
            { label: 'Joomla Projects', value: '100', suffix: '+' },
            { label: 'Years Experience', value: '15', suffix: '+' },
            { label: 'Custom Extensions Built', value: '50', suffix: '+' },
        ...
        <section id="contact" className="jo-contact" aria-labelledby="jo-contact-heading">
          <div className="jo-contact-grid">
            ...
            <div className="jo-form-box">
              ...
              <form className="jo-form" onSubmit={_sfSubmit}>
                <div className="jo-frow">
                  <div className="jo-fg"><label htmlFor="jo-name">Full Name *</label><input name="sf-name" id="jo-name" type="text" placeholder="Your name" required /></div>
                  <div className="jo-fg"><label htmlFor="jo-email">Work Email *</label><input id="jo-email" type="email" name="sf-email" placeholder="you@company.com" required /></div>
                </div>
                <div className="jo-frow">
                  <div className="jo-fg"><label htmlFor="jo-company">Company / Website URL</label><input name="sf-company" id="jo-company" type="text" placeholder="Company or website URL" /></div>
                  <div className="jo-fg"><label htmlFor="jo-phone">Phone / WhatsApp *</label><input id="jo-phone" type="tel" name="sf-phone" placeholder="+1 555 000 0000" required /></div>
                </div>
