...
export default function MetaAdsManagement() {
  ...
  return (
    <>
      <Head>
        ...
        <style>{`
          *{box-sizing:border-box}
          ...
          .meta-h2 span{background:linear-gradient(135deg,#4f46e5,#7c3aed,#a855f7,#ec4899,#3b82f6,#06b6d4,#4f46e5);background-size:300% 300%;animation:aurora-text 6s ease infinite;-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}
      ...
      <section className="meta-cta"><div className="meta-si2"><span className="meta-tag" style={{display:'block',textAlign:'center',marginBottom:12}}>Ready to Improve Your Meta Ads?</span><h2 className="meta-cth">Get a Free Meta Ads Audit</h2><p className="meta-ctp">We will review your Facebook and Instagram campaigns, pixel setup, audience strategy, and creative performance - and share a clear improvement plan, completely free.</p><div style={{display:'flex',gap:14,justifyContent:'center',flexWrap:'wrap'}}><Link href="/contact-us/" className="meta-bp">Request Free Audit <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14M12 5l7 7-7 7"/></svg></Link><Link href="/contact-us/" className="meta-bs">Talk to a Meta Ads Specialist</Link></div></div></section>
    </>
  );
}
