  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="Google Ads PPC Management | 1Solutions" />
        <meta property="og:description" content="Google Ads management by 1Solutions. Search, Display, Shopping, YouTube, and Performance Max campaigns engineered for ROAS and lead generation." />
        <meta property="og:url" content="https://www.1solutions.biz/ppc-management-services/" />
        <meta key="og-image" property="og:image" content="https://www.1solutions.biz/images/og-ppc-management-services.jpg" />
        <meta key="og-image-w" property="og:image:width" content="1200" />
        <meta key="og-image-h" property="og:image:height" content="630" />
        <meta key="og-image-type" property="og:image:type" content="image/jpeg" />
        <meta property="og:image:alt" content="1Solutions PPC Management Services" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:image" content="https://www.1solutions.biz/images/og-ppc-management-services.jpg" />
        <meta name="twitter:image:alt" content="1Solutions PPC Management Services" />
        ...
        <style>{`
          *{box-sizing:border-box}
          ...
          .gppc-h2 span{background:linear-gradient(135deg,#4f46e5,#7c3aed,#a855f7,#ec4899,#3b82f6,#06b6d4,#4f46e5);background-size:300% 300%;animation:aurora-text 6s ease infinite;-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}
