    ...
    try {
      ...
      const res = await fetch('/api/contact', {
        ...
        body: JSON.stringify({
          ...
          source: 'Agriculture Software Development', consent: true, recaptchaToken: token,
        }),
      });
  ...
  return (
    <>
      <Head>
        ...
        <meta key="og-image" property="og:image" content="https://www.1solutions.biz/images/og-agriculture-software-development.jpg" />
        <meta key="og-image-w" property="og:image:width" content="1200" />
        <meta key="og-image-h" property="og:image:height" content="630" />
        <meta key="og-image-type" property="og:image:type" content="image/jpeg" />
        <meta property="og:image:alt" content="1Solutions Agriculture Software Development" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:image" content="https://www.1solutions.biz/images/og-agriculture-software-development.jpg" />
        <meta name="twitter:image:alt" content="1Solutions Agriculture Software Development" />
      ...
      <div className="agr-page">
        ...
        <div className="agr-fb"><h3>Tell Us About Your AgriTech Project</h3><form className="agr-form" onSubmit={_sfSubmit}><div className="agr-fr"><div className="agr-fg"><label>Full Name *</label><input name="sf-name" type="text" placeholder="Your name" required /></div><div className="agr-fg"><label>Work Email *</label><input type="email" name="sf-email" placeholder="you@company.com" required /></div></div><div className="agr-fr"><div className="agr-fg"><label>Company / Farm</label><input name="sf-name" type="text" placeholder="Company name" /></div><div className="agr-fg"><label>Phone / WhatsApp</label><input type="tel" name="sf-phone" placeholder="+1 555 000 0000" /></div></div><div className="agr-fg full"><label>Type of AgriTech Platform *</label><select required><option value="">Select...</option><option>Farm Management System (FMS)</option><option>Precision Agriculture / IoT Platform</option><option>Crop Monitoring & Yield Prediction</option><option>Livestock Management Software</option><option>Agri-Marketplace / eCommerce</option><option>Supply Chain Traceability</option><option>Irrigation Management System</option><option>Drone / Aerial Imagery Analytics</option><option>Weather & Climate Analytics</option><option>Agricultural ERP Integration</option><option>Other</option></select></div><div className="agr-fg full"><label>Project Description *</label><textarea name="sf-message" rows={4} placeholder="Describe your agriculture software project - farm type, scale, current systems, key challenges, and timeline..." required /></div><div className="agr-co"><input type="checkbox" required /><label>I agree to the <Link href="/privacy-policy/">Privacy Policy</Link>. Details are treated confidentially.</label></div><button type="submit" className="agr-sub">Get an AgriTech Proposal →</button>
