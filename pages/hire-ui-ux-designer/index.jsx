...
export default function HireUiUxDesigner() {
  ...
  const LD = {
    ...
    '@graph': [
      { '@type': 'BreadcrumbList', itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Hire UI/UX Designer', item: 'https://www.1solutions.biz/hire-ui-ux-designer/' },
      ]},
      { '@type': 'Service', name: 'Hire UI/UX Designer', provider: { '@type': 'Organization', name: '1Solutions' },
  ...
  return (
    <>
      <Head>
        <title>Hire UI/UX Designer | Figma & User Research Experts | 1Solutions</title>
        ...
        <link rel="canonical" href="https://www.1solutions.biz/hire-ui-ux-designer/" />
      ...
      <section className="huiux-hero">
        <h1>Hire UI/UX Designers<br/>Figma &amp; User Research Specialists</h1>
      ...
      <section className="huiux-cta">
        <div className="huiux-wrap">
          <h2>Ready to Hire Your UI/UX Designer?</h2>
