    ...
    try {
      ...
      const res = await fetch('/api/contact', {
        ...
        body: JSON.stringify({
          ...
          source: 'Logistics Software Development Services', consent: true, recaptchaToken: token,
        }),
      });
  ...
  return (
    <>
      ...
      <div className="lgt-page">
        ...
        <div className="lgt-fb"><h3>Tell Us About Your Logistics Project</h3><form className="lgt-form" onSubmit={_sfSubmit}><div className="lgt-fr"><div className="lgt-fg"><label>Full Name *</label><input name="sf-name" type="text" placeholder="Your name" required /></div><div className="lgt-fg"><label>Work Email *</label><input type="email" name="sf-email" placeholder="you@company.com" required /></div></div><div className="lgt-fr"><div className="lgt-fg"><label>Company</label><input name="sf-name" type="text" placeholder="Company name" /></div><div className="lgt-fg"><label>Phone / WhatsApp</label><input type="tel" name="sf-phone" placeholder="+1 555 000 0000" /></div></div><div className="lgt-fg full"><label>Type of Logistics Platform *</label><select required><option value="">Select...</option><option>Transportation Management System (TMS)</option><option>Warehouse Management System (WMS)</option><option>Last-Mile Delivery Platform</option><option>Route Optimisation Engine</option><option>Fleet Management & Telematics</option><option>Freight Forwarding / Brokerage Software</option><option>Carrier & 3PL API Integration</option><option>Supply Chain Visibility Platform</option><option>3PL / 4PL Management Platform</option><option>Logistics Analytics Dashboard</option><option>Other</option></select></div><div className="lgt-fg full"><label>Project Description *</label><textarea name="sf-message" rows={4} placeholder="Describe your logistics software project - current systems (if any), shipment volumes, carrier network, key challenges, and timeline..." required /></div><div className="lgt-co"><input type="checkbox" required /><label>I agree to the <Link href="/privacy-policy/">Privacy Policy</Link>. Details are treated confidentially.</label></div><button type="submit" className="lgt-sub">Get a Logistics Platform Proposal →</button>
