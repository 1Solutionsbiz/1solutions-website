  ...
  return (
    <>
      <Head>
        ...
        <meta key="og-image" property="og:image" content="https://www.1solutions.biz/images/og-photography-seo-services.jpg" />
        <meta key="og-image-w" property="og:image:width" content="1200" />
        <meta key="og-image-h" property="og:image:height" content="630" />
        <meta key="og-image-type" property="og:image:type" content="image/jpeg" />
        <meta property="og:image:alt" content="1Solutions Photography SEO Services" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:image" content="https://www.1solutions.biz/images/og-photography-seo-services.jpg" />
        <meta name="twitter:image:alt" content="1Solutions Photography SEO Services" />
        ...
        <style>{`
          ...
          @media(max-width:768px){.phseo-svc,.phseo-niches,.phseo-proc,.phseo-why,.phseo-faq,.phseo-cta{padding:60px 24px}.phseo-grid{grid-template-columns:1fr}.phseo-why-grid{grid-template-columns:1fr}.phseo-step{grid-template-columns:56px 1fr}}
