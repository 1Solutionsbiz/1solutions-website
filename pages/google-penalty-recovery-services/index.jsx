  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:image:alt" content="1Solutions Google Penalty Recovery Services — recover from manual and algorithmic penalties" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:image" content="https://www.1solutions.biz/images/og-google-penalty-recovery-services.jpg" />
        <meta name="twitter:image:alt" content="1Solutions Google Penalty Recovery Services — recover from manual and algorithmic penalties" />
        ...
        <style>{`
          ...
          @media(max-width:768px){.gpr-svc,.gpr-types,.gpr-proc,.gpr-why,.gpr-faq,.gpr-cta{padding:60px 24px}.gpr-grid{grid-template-columns:1fr}.gpr-why-grid{grid-template-columns:1fr}.gpr-step{grid-template-columns:56px 1fr}.gpr-btns{flex-direction:column;align-items:center}}
