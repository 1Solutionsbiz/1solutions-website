    ...
    try {
      ...
      const res = await fetch('/api/contact', {
        ...
        body: JSON.stringify({
          ...
          source: 'Fintech Software Development Company', consent: true, recaptchaToken: token,
        }),
      });
  ...
  return (
    <>
      <Head>
        ...
        <meta key="og-image" property="og:image" content="https://www.1solutions.biz/images/og-fintech-software-development-company.jpg" />
        <meta key="og-image-w" property="og:image:width" content="1200" />
        <meta key="og-image-h" property="og:image:height" content="630" />
        <meta key="og-image-type" property="og:image:type" content="image/jpeg" />
        <meta property="og:image:alt" content="1Solutions Fintech Software Development" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:image" content="https://www.1solutions.biz/images/og-fintech-software-development-company.jpg" />
        <meta name="twitter:image:alt" content="1Solutions Fintech Software Development" />
        ...
        <style>{`
          ...
          .ft-related h2 { font-size:34px;font-weight:900;background:linear-gradient(135deg,#4f46e5,#7c3aed,#a855f7,#ec4899,#3b82f6,#06b6d4,#4f46e5);background-size:300% 300%;animation:aurora-text 6s ease infinite;-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;margin:10px 0 12px; }
        ...
        <section id="contact" className="ft-contact" aria-labelledby="ft-contact-heading">
          <div className="ft-contact-grid">
            ...
            <div className="ft-form-box">
              ...
              <form className="ft-form" onSubmit={_sfSubmit}>
                <div className="ft-frow">
                  <div className="ft-fg">
                    <label htmlFor="ft-name">Full Name *</label>
                    <input name="sf-name" id="ft-name" type="text" placeholder="Your name" required />
                  </div>
                  <div className="ft-fg">
                    <label htmlFor="ft-email">Work Email *</label>
                    <input id="ft-email" type="email" name="sf-email" placeholder="you@company.com" required />
                  </div>
                </div>
                <div className="ft-frow">
                  <div className="ft-fg">
                  ...
                  <div className="ft-fg">
                    ...
                    <input id="ft-phone" type="tel" name="sf-phone" placeholder="+1 555 000 0000" required />
                  </div>
                </div>
                ...
                <div className="ft-fg full">
                  ...
                  <textarea name="sf-message" id="ft-msg" rows={4} placeholder="Describe your fintech product, target market, regulatory requirements, and timeline..." required />
                </div>
