  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="Google Shopping Management | 1Solutions" />
        <meta property="og:description" content="Google Shopping campaign management by 1Solutions. Product feed optimisation, Performance Max, and ROAS-focused bidding for eCommerce stores." />
        <meta property="og:url" content="https://www.1solutions.biz/google-shopping-management/" />
        <meta key="og-image" property="og:image" content="https://www.1solutions.biz/images/og-google-shopping-management.jpg" />
        <meta key="og-image-w" property="og:image:width" content="1200" />
        <meta key="og-image-h" property="og:image:height" content="630" />
        <meta key="og-image-type" property="og:image:type" content="image/jpeg" />
        <meta property="og:image:alt" content="1Solutions Google Shopping Management" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:image" content="https://www.1solutions.biz/images/og-google-shopping-management.jpg" />
        <meta name="twitter:image:alt" content="1Solutions Google Shopping Management" />
        ...
        <style>{`
          *{box-sizing:border-box}
          ...
          .gsho-h2 span{background:linear-gradient(135deg,#4f46e5,#7c3aed,#a855f7,#ec4899,#3b82f6,#06b6d4,#4f46e5);background-size:300% 300%;animation:aurora-text 6s ease infinite;-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}
          ...
          @media(max-width:600px){.gsho-sec,.gsho-rb,.gsho-cta{padding-left:20px;padding-right:20px}.gsho-g3,.gsho-rg{grid-template-columns:1fr}.gsho-bc{padding:12px 20px}}
      ...
      <ServiceHero
        ...
        stats={[
          ...
          { label: 'Avg ROAS', value: '6', prefix: '4.', suffix: '×' },
