  ...
  return (
    <>
      <Head>
        ...
        <meta key="og-image" property="og:image" content="https://www.1solutions.biz/images/og-ios-app-development-company.jpg" />
        <meta key="og-image-w" property="og:image:width" content="1200" />
        <meta key="og-image-h" property="og:image:height" content="630" />
        <meta key="og-image-type" property="og:image:type" content="image/jpeg" />
        <meta property="og:image:alt" content="1Solutions iOS App Development" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:image" content="https://www.1solutions.biz/images/og-ios-app-development-company.jpg" />
        <meta name="twitter:image:alt" content="1Solutions iOS App Development" />
        ...
        <style>{`
          ...
          .io-related h2{font-size:34px;font-weight:900;background:linear-gradient(135deg,#4f46e5,#7c3aed,#a855f7,#ec4899,#3b82f6,#06b6d4,#4f46e5);background-size:300% 300%;animation:aurora-text 6s ease infinite;-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;margin:10px 0 12px}
          ...
          <div className="io-inner">
            ...
            <div className="io-tgrid" ref={testiGridRef}>
              {TESTIMONIALS.map((t, i) => (
                <div key={i} className={`io-tcard${t.feat ? ' feat' : ''}${visibleTestiCards.includes(i) ? ' io-tv' : ''}`} style={{ transitionDelay: `${i * 100}ms` }}>
                  <div className="io-stars" aria-label="5 out of 5 stars">★★★★★</div>
                  <p className="io-ttext">{t.text}</p>
                  <div className="io-tauthor">
                    <div className="io-tavatar" style={{ background: t.bg }}>{t.init}</div>
                    <div><div className="io-tname">{t.name}</div><div className="io-trole">{t.role}</div></div>
                  </div>
                </div>
              ))}
            </div>
        ...
        <section className="io-related">
          <div className="io-related-inner">
            ...
            <div className="io-rtags">
              {[['/android-application-development-company/','Android App Development','io-rtag-green'],['/flutter-app-development-services/','Flutter App Development','io-rtag-sky'],['/react-native-app-development/','React Native Development','io-rtag-violet'],['/mobile-app-development/','Mobile App Development','io-rtag-blue'],['/saas-application-development-company/','SaaS Development Company','io-rtag-amber'],['/ui-ux-design-services/','UI/UX Design Services','io-rtag-violet'],['/erp-application-development-company/','ERP Application Development','io-rtag-amber'],['/crm-application-development-company/','CRM Application Development','io-rtag-teal'],['/api-development-company/','API Development & Integration','io-rtag-sky'],['/hire-ios-developer/','Hire iOS Developer','io-rtag-blue']].map(([href, label, cls]) => (
