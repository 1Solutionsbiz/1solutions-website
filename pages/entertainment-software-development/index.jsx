    ...
    try {
      ...
      const res = await fetch('/api/contact', {
        ...
        body: JSON.stringify({
          ...
          source: 'Entertainment Software Development', consent: true, recaptchaToken: token,
        }),
      });
  ...
  return (
    <>
      <Head>
        ...
        <meta key="og-image" property="og:image" content="https://www.1solutions.biz/images/og-entertainment-software-development.jpg" />
        <meta key="og-image-w" property="og:image:width" content="1200" />
        <meta key="og-image-h" property="og:image:height" content="630" />
        <meta key="og-image-type" property="og:image:type" content="image/jpeg" />
        <meta property="og:image:alt" content="1Solutions Entertainment Software Development" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:image" content="https://www.1solutions.biz/images/og-entertainment-software-development.jpg" />
        <meta name="twitter:image:alt" content="1Solutions Entertainment Software Development" />
        ...
        <style>{`
          ...
          .ent-ri h2{font-size:30px;font-weight:900;background:linear-gradient(135deg,#4f46e5,#7c3aed,#a855f7,#ec4899,#3b82f6,#06b6d4,#4f46e5);background-size:300% 300%;animation:aurora-text 6s ease infinite;-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;margin:10px 0 10px}
      ...
      <div className="ent-page">
        ...
        <div className="ent-fb"><h3>Tell Us About Your Entertainment Project</h3><form className="ent-form" onSubmit={_sfSubmit}><div className="ent-fr"><div className="ent-fg"><label>Full Name *</label><input name="sf-name" type="text" placeholder="Your name" required /></div><div className="ent-fg"><label>Work Email *</label><input type="email" name="sf-email" placeholder="you@company.com" required /></div></div><div className="ent-fr"><div className="ent-fg"><label>Company</label><input name="sf-name" type="text" placeholder="Company name" /></div><div className="ent-fg"><label>Phone / WhatsApp</label><input type="tel" name="sf-phone" placeholder="+1 555 000 0000" /></div></div><div className="ent-fg full"><label>Type of Entertainment Platform *</label><select required><option value="">Select...</option><option>OTT Video Streaming Platform</option><option>Music / Podcast Streaming</option><option>Media Asset Management (MAM)</option><option>AI Content Recommendation Engine</option><option>Gaming Platform / Portal</option><option>Digital Ticketing & Events</option><option>Live Streaming / Broadcasting</option><option>Fan Engagement & Community</option><option>Rights & Royalty Management</option><option>Media Analytics</option><option>Other</option></select></div><div className="ent-fg full"><label>Project Description *</label><textarea name="sf-message" rows={4} placeholder="Describe your entertainment platform - type of content, target audience, existing systems, scale targets, and go-live timeline..." required /></div><div className="ent-co"><input type="checkbox" required /><label>I agree to the <Link href="/privacy-policy/">Privacy Policy</Link>. Details are treated confidentially.</label></div><button type="submit" className="ent-sub">Get an Entertainment Tech Proposal →</button>
        ...
        <section className="ent-rel"><div className="ent-ri"><span className="ent-sey">Related Services</span><h2>Related Industry & Technology Services</h2><hr /><div className="ent-rts">{[['/social-media-app-development-company/','Social Media App Development','ent-ra'],['/mobile-app-development/','Mobile App Development','ent-rb'],['/retail-ecommerce-software-development/','Retail & eCommerce','ent-rc'],['/saas-application-development-company/','SaaS Development','ent-rd'],['/it-outsourcing-services/','IT Outsourcing','ent-ra'],['/offshore-development-company/','Offshore Development','ent-rb'],['/web-development/','Web Development','ent-rc'],['/ai-solutions/','AI/ML Development','ent-rd']].map(([hr, lb, cl]) => (<Link key={hr} href={hr} className={`ent-rt ${cl}`}>{lb}</Link>))}</div></div></section>
      </div>
    </>
  );
}
