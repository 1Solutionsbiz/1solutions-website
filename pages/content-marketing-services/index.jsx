  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="Content Marketing Services | 1Solutions" />
        <meta property="og:description" content="Content marketing by 1Solutions - SEO blog content, pillar pages, case studies, and content strategy that builds organic traffic and converts readers into" />
        <meta property="og:url" content="https://www.1solutions.biz/content-marketing-services/" />
        <meta key="og-image" property="og:image" content="https://www.1solutions.biz/images/og-content-marketing-services.jpg" />
        <meta key="og-image-w" property="og:image:width" content="1200" />
        <meta key="og-image-h" property="og:image:height" content="630" />
        <meta key="og-image-type" property="og:image:type" content="image/jpeg" />
        <meta property="og:image:alt" content="1Solutions Content Marketing Services" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:image" content="https://www.1solutions.biz/images/og-content-marketing-services.jpg" />
        <meta name="twitter:image:alt" content="1Solutions Content Marketing Services" />
        ...
        <style>{`
          *{box-sizing:border-box}
          ...
          .cmkt-bci a:hover{color:${ACCENT}}.cmkt-cur{color:${ACCENT};font-weight:500}
          ...
          .cmkt-h2 span{background:linear-gradient(135deg,#4f46e5,#7c3aed,#a855f7,#ec4899,#3b82f6,#06b6d4,#4f46e5);background-size:300% 300%;animation:aurora-text 6s ease infinite;-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}
          ...
          @media(max-width:600px){.cmkt-sec,.cmkt-rb,.cmkt-cta{padding-left:20px;padding-right:20px}.cmkt-g3,.cmkt-rg{grid-template-columns:1fr}.cmkt-bc{padding:12px 20px}}
      ...
      <ServiceHero
        ...
        stats={[
          ...
          { label: 'Top-3 Rankings', value: '62' },
          { label: 'Lead Growth', value: '1', prefix: '4.', suffix: '×' },
        ]}
      />
