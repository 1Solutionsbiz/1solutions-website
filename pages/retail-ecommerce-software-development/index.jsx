    ...
    <>
      <Head>
        ...
        <style>{`
          ...
          .rce-ri h2{font-size:30px;font-weight:900;background:linear-gradient(135deg,#4f46e5,#7c3aed,#a855f7,#ec4899,#3b82f6,#06b6d4,#4f46e5);background-size:300% 300%;animation:aurora-text 6s ease infinite;-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;margin:10px 0 10px}
      ...
      <div className="rce-page">
        ...
        <ServiceHero
          eyebrow="Retail & eCommerce Industry"
          title={<>Retail & eCommerce Software Development - <AuroraText>Headless Commerce, Marketplace & OMS</AuroraText></>}
          subtext="Custom retail technology for brands, multi-vendor marketplaces, D2C businesses, and omnichannel retailers - headless commerce storefronts, OMS, POS integration, loyalty platforms, AI personalisation, and subscription commerce. 150+ retail/eCommerce projects. 15+ years."
          primaryCta={{ label: 'Discuss Your eCommerce Platform', href: '#contact' }}
          secondaryCta={{ label: 'View Solutions', href: '#solutions' }}
          stats={[
            { label: 'Retail / eCommerce Projects', value: '150', suffix: '+' },
            { label: 'Years Dev Experience', value: '15', suffix: '+' },
            { label: 'Avg Conversion Rate Lift', value: '34', suffix: '%' },
        ...
        <div className="rce-fb"><h3>Tell Us About Your Retail Platform</h3><form className="rce-form" onSubmit={_sfSubmit}><div className="rce-fr"><div className="rce-fg"><label>Full Name *</label><input name="sf-name" type="text" placeholder="Your name" required /></div><div className="rce-fg"><label>Work Email *</label><input type="email" name="sf-email" placeholder="you@company.com" required /></div></div><div className="rce-fr"><div className="rce-fg"><label>Company</label><input name="sf-company" type="text" placeholder="Your company" /></div><div className="rce-fg"><label>Phone / WhatsApp</label><input type="tel" name="sf-phone" placeholder="+1 555 000 0000" /></div></div><div className="rce-fg full"><label>Type of Retail Platform *</label><select required><option value="">Select...</option><option>Custom eCommerce Storefront</option><option>Headless Commerce Migration</option><option>Multi-Vendor Marketplace</option><option>Order Management System (OMS)</option><option>Loyalty / Subscription Platform</option><option>POS Integration / Omnichannel</option><option>Product Information Management (PIM)</option><option>D2C / B2B eCommerce Portal</option><option>AI Personalisation / Recommendation</option><option>Other</option></select></div><div className="rce-fg full"><label>Project Description *</label><textarea name="sf-message" rows={4} placeholder="Describe your retail technology project - current platform (if any), key features needed, traffic scale, revenue target, and timeline..." required /></div><div className="rce-co"><input type="checkbox" required /><label>I agree to the <Link href="/privacy-policy/">Privacy Policy</Link>. Details are treated confidentially.</label></div><button type="submit" className="rce-sub">Get an eCommerce Proposal →</button>
