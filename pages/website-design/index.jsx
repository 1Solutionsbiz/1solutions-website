...
const WHY = [
  ...
  },
  {
    ...
    desc: 'Since 2010 we have designed 500+ websites across every major industry. Our experience means fewer revisions and faster time to launch.',
  },
  {
    ...
    <>
      <Head>
        ...
        <style>{`
          ...
          .wd-section-title { font-size:48px;font-weight:900;line-height:1.15;letter-spacing:-1px;background:linear-gradient(135deg,#4f46e5,#7c3aed,#a855f7,#ec4899,#3b82f6,#06b6d4,#4f46e5);background-size:300% 300%;animation:aurora-text 6s ease infinite;-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;color:transparent;margin-bottom:10px; }
          ...
          .wd-faq-heading { font-size:48px;font-weight:900;line-height:1.15;letter-spacing:-1px;background:linear-gradient(135deg,#4f46e5,#7c3aed,#a855f7,#ec4899,#3b82f6,#06b6d4,#4f46e5);background-size:300% 300%;animation:aurora-text 6s ease infinite;-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;color:transparent;margin:0 0 36px; }
          ...
          .wd-related-title { font-size:48px;font-weight:900;line-height:1.15;letter-spacing:-1px;background:linear-gradient(135deg,#4f46e5,#7c3aed,#a855f7,#ec4899,#3b82f6,#06b6d4,#4f46e5);background-size:300% 300%;animation:aurora-text 6s ease infinite;-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;color:transparent;margin:0 0 16px; }
          ...
          <div className="wd-contact-container">
            ...
            <div>
              <div className="wd-form-box">
                ...
                <form className="wd-contact-form" onSubmit={_sfSubmit}>
                  <div className="wd-form-row">
                    <div className="wd-form-group"><label>Full Name*</label><input name="sf-name" type="text" placeholder="Full Name*" required /></div>
                    <div className="wd-form-group"><label>Business Email*</label><input type="email" name="sf-email" placeholder="Business Email Address*" required /></div>
                  </div>
                  <div className="wd-form-row">
                    ...
                    <div className="wd-form-group"><label>Organisation*</label><input name="sf-company" type="text" placeholder="Company / Organisation*" required /></div>
                  </div>
                  <div className="wd-form-group full"><label>Tell us about your project*</label><textarea name="sf-message" placeholder="Describe your website design project, current challenges, and goals..." rows={6} required /></div>
