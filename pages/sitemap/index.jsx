...
const SECTIONS = [
  ...
  },
  {
    ...
    columns: [
      ...
      [
        ...
        { label: 'App Maintenance Services',     href: '/app-maintenance-services/' },
        { label: 'App Store Optimization',       href: '/app-store-optimization-services/' },
  ...
  {
    id: 'ai-geo',
    heading: 'AI Search & GEO Services',
    columns: [
      [
        { label: 'Free AI Visibility Audit',              href: '/free-ai-visibility-audit/' },
        { label: 'AI Search Services',                     href: '/ai-search-services/' },
        { label: 'AI SEO Services',                        href: '/ai-seo-services/' },
        { label: 'Generative Engine Optimization (GEO)',   href: '/generative-engine-optimization-services/' },
      ...
      [
        ...
        { label: 'Voice Search Optimization',               href: '/voice-search-optimization-services/' },
        { label: 'ChatGPT SEO Services',                    href: '/chatgpt-seo/' },
      ],
      [
        { label: 'Perplexity AI SEO Services',              href: '/perplexity-ai-seo/' },
        { label: 'SearchGPT SEO',                           href: '/searchgpt-seo/' },
        { label: 'Google AI SEO',                           href: '/google-ai-seo/' },
        { label: 'Meta AI SEO',                             href: '/meta-ai-seo/' },
      ],
    ],
  },
  {
  ...
  },
  {
    ...
    columns: [
      ...
      [
        ...
        { label: 'Home Services Website Design',         href: '/home-services-website-design/' },
      ],
    ],
  },
  {
    ...
    columns: [
      [
        ...
        { label: 'Google Penalty Recovery',       href: '/google-penalty-recovery-services/' },
        { label: 'Google Panda Recovery',         href: '/google-panda-recovery-services/' },
        { label: 'Penguin Recovery Service',      href: '/penguin-recovery-service/' },
        { label: 'Free 45-Day SEO Trial',         href: '/free-45-day-seo-trial/' },
        ...
        { label: 'Managed SEO Services',          href: '/managed-seo-services/' },
        { label: 'Shopify SEO Services',          href: '/shopify-seo-services/' },
        { label: 'WooCommerce SEO Services',      href: '/woocommerce-seo-services/' },
        { label: 'WordPress SEO Services',        href: '/wordpress-seo-services/' },
        { label: 'Magento SEO Services',          href: '/magento-seo-services/' },
        { label: 'OpenCart SEO Services',         href: '/opencart-seo-services/' },
        { label: 'Wix SEO Services',              href: '/wix-seo-services/' },
      ],
      [
      ...
      [
        ...
        { label: 'Lawn Care Marketing',           href: '/lawn-care-marketing-services/' },
        { label: 'HVAC SEO Services',             href: '/hvac-seo-services/' },
        { label: 'Photography SEO Services',      href: '/photography-seo-services/' },
        { label: 'SEO Training Laxmi Nagar',      href: '/seo-training-laxmi-nagar/' },
      ],
    ],
  },
  {
  ...
  },
  {
    ...
    columns: [
      ...
      [
        ...
        { label: 'SEO Company Los Angeles',  href: '/seo-company-los-angeles/' },
        { label: 'SEO Services California',  href: '/seo-services-california/' },
      ],
    ],
  },
  {
  ...
  },
  {
    ...
    columns: [
      ...
      [
        ...
        { label: 'Hire Dedicated UI/UX Designer',   href: '/hire-dedicated-ui-ux-designer/' },
