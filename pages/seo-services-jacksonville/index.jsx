...
export default function SeoServicesJacksonville() {
  ...
  const LD = {
    ...
    '@graph': [
      ...
      { '@type': 'ProfessionalService', name: 'SEO Services Jacksonville', provider: { '@type': 'Organization', name: '1Solutions' },
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="SEO Services Jacksonville FL | 1Solutions" />
        <meta property="og:description" content="Expert SEO services in Jacksonville, FL from 1Solutions. We help Jacksonville businesses rank higher on Google, drive local traffic, and grow revenue" />
        <meta property="og:url" content="https://www.1solutions.biz/seo-services-jacksonville/" />
        <meta key="og-image" property="og:image" content="https://www.1solutions.biz/images/og-seo-services-jacksonville.jpg" />
        <meta key="og-image-w" property="og:image:width" content="1200" />
        <meta key="og-image-h" property="og:image:height" content="630" />
        <meta key="og-image-type" property="og:image:type" content="image/jpeg" />
        <meta property="og:image:alt" content="1Solutions SEO Services Jacksonville FL" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:image" content="https://www.1solutions.biz/images/og-seo-services-jacksonville.jpg" />
        <meta name="twitter:image:alt" content="1Solutions SEO Services Jacksonville FL" />
