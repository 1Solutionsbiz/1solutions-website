    ...
    try {
      ...
      const res = await fetch('/api/contact', {
        ...
        body: JSON.stringify({
          ...
          source: 'Cloud Native Services', consent: true, recaptchaToken: token,
        }),
      });
  ...
  return (
    <>
      <Head>
        ...
        <meta key="og-image" property="og:image" content="https://www.1solutions.biz/images/og-cloud-native-services.jpg" />
        <meta key="og-image-w" property="og:image:width" content="1200" />
        <meta key="og-image-h" property="og:image:height" content="630" />
        <meta key="og-image-type" property="og:image:type" content="image/jpeg" />
        <meta property="og:image:alt" content="1Solutions Cloud Native Services" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:image" content="https://www.1solutions.biz/images/og-cloud-native-services.jpg" />
        <meta name="twitter:image:alt" content="1Solutions Cloud Native Services" />
        ...
        <style>{`
          ...
          .cn-related h2{font-size:34px;font-weight:900;background:linear-gradient(135deg,#4f46e5,#7c3aed,#a855f7,#ec4899,#3b82f6,#06b6d4,#4f46e5);background-size:300% 300%;animation:aurora-text 6s ease infinite;-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;margin:10px 0 12px}
        ...
        <section id="contact" className="cn-contact" aria-labelledby="cn-contact-heading">
          <div className="cn-contact-grid">
            ...
            <div className="cn-form-box">
              ...
              <form className="cn-form" onSubmit={_sfSubmit}>
                <div className="cn-frow">
                  <div className="cn-fg"><label htmlFor="cn-name">Full Name *</label><input name="sf-name" id="cn-name" type="text" placeholder="Your name" required /></div>
                ...
                <div className="cn-fg full">
                  ...
                  <textarea name="sf-message" id="cn-msg" rows={4} placeholder="Describe your application, architecture goals, scale requirements (requests/sec, events/sec, data volumes), team size, current pain points (monolith coupling, scaling issues, deployment frequency), and target cloud platform..." required />
                </div>
